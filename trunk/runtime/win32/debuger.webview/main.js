...
(function ($, window) {
    ...
    $(document).ready(function () {
        ...
        $("#code_submit_btn").button().click(function () {
            ...
            if (window.debuger)
                debuger.call('run_code', [$("#select_mode").val(), $("#code_engine_type").val(), code_content]);
            else
        ...
        $("#code_load_clear_btn").button({
            icons: {
                primary: $("#code_load_clear_btn").prop('checked') ? "ui-icon-check" : "ui-icon-closethick"
            }
        }).change(function () {
            ...
            menu_ele
                .menu({
                    select: function (event, ui) {
                        ...
                        if (!$("#code_load_clear_btn").prop('checked')) {
                            code = editor_info.editor.doc.getValue() + "\r\n" + code;
                        }
