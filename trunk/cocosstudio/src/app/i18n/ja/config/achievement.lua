...
local achievement = {
    ...
    _data = {
        ...
        [55] = {105001,"日々向上","戦力が%dに達する",},
        [56] = {105002,"日々向上","戦力が%dに達する",},
        [57] = {105003,"日々向上","戦力が%dに達する",},
        [58] = {105004,"日々向上","戦力が%dに達する",},
        [59] = {105005,"日々向上","戦力が%dに達する",},
        [60] = {105006,"日々向上","戦力が%dに達する",},
        [61] = {105007,"日々向上","戦力が%dに達する",},
        [62] = {105008,"日々向上","戦力が%dに達する",},
        [63] = {105009,"日々向上","戦力が%dに達する",},
        [64] = {105010,"日々向上","戦力が%dに達する",},
        [65] = {107001,"ファイト！","全出陣武将の突破が＋%d以上になる",},
        [66] = {107002,"ファイト！","全出陣武将の突破が＋%d以上になる",},
        [67] = {107003,"ファイト！","全出陣武将の突破が＋%d以上になる",},
        [68] = {107004,"ファイト！","全出陣武将の突破が＋%d以上になる",},
        [69] = {107005,"ファイト！","全出陣武将の突破が＋%d以上になる",},
        [70] = {107006,"ファイト！","全出陣武将の突破が＋%d以上になる",},
        [71] = {107007,"ファイト！","全出陣武将の突破が＋%d以上になる",},
        [72] = {107008,"ファイト！","全出陣武将の突破が＋%d以上になる",},
        [73] = {107009,"ファイト！","全出陣武将の突破が＋%d以上になる",},
        [74] = {107010,"ファイト！","全出陣武将の突破が＋%d以上になる",},
        [75] = {109001,"宝物強化","全宝物がLv%dになる",},
        [76] = {109002,"宝物強化","全宝物がLv%dになる",},
        [77] = {109003,"宝物強化","全宝物がLv%dになる",},
        [78] = {109004,"宝物強化","全宝物がLv%dになる",},
        [79] = {109005,"宝物強化","全宝物がLv%dになる",},
        [80] = {109006,"宝物強化","全宝物がLv%dになる",},
        [81] = {109007,"宝物強化","全宝物がLv%dになる",},
        [82] = {109008,"宝物強化","全宝物がLv%dになる",},
        [83] = {109009,"宝物強化","全宝物がLv%dになる",},
        [84] = {109010,"宝物強化","全宝物がLv%dになる",},
        ...
        [99] = {113002,"昇進","官職が司馬に昇進する",},
        [100] = {113003,"昇進","官職が都尉に昇進する",},
        [101] = {113004,"昇進","官職が校尉に昇進する",},
        [102] = {113005,"昇進","官職が太守に昇進する",},
        [103] = {113006,"昇進","官職が刺史に昇進する",},
        [104] = {113007,"昇進","官職が中郎将に昇進する",},
        [105] = {113008,"昇進","官職が京兆尹に昇進する",},
        [106] = {113009,"昇進","官職が尚書令に昇進する",},
        [107] = {113010,"昇進","官職が衛将軍に昇進する",},
        [108] = {113011,"昇進","官職が大都督に昇進する",},
        [109] = {113012,"昇進","官職が大将軍に昇進する",},
        ...
        [119] = {115001,"装備精錬","全装備を＋%dまで精錬する",},
        [120] = {115002,"装備精錬","全装備を＋%dまで精錬する",},
        [121] = {115003,"装備精錬","全装備を＋%dまで精錬する",},
        [122] = {115004,"装備精錬","全装備を＋%dまで精錬する",},
        [123] = {115005,"装備精錬","全装備を＋%dまで精錬する",},
        [124] = {115006,"装備精錬","全装備を＋%dまで精錬する",},
        [125] = {115007,"装備精錬","全装備を＋%dまで精錬する",},
        [126] = {115008,"装備精錬","全装備を＋%dまで精錬する",},
        [127] = {115009,"装備精錬","全装備を＋%dまで精錬する",},
        [128] = {115010,"装備精錬","全装備を＋%dまで精錬する",},
        [129] = {115011,"装備精錬","全装備を＋%dまで精錬する",},
        ...
        [167] = {201001,"温酒斬華雄","味方の関羽が華雄を撃破",},
        [168] = {202002,"生死をともに","曹丕が甄姫を撃破",},
        [169] = {203003,"火焼連営","陸遜が劉備を撃破",},
        [170] = {204004,"赤壁の戦い","劉備と孫権が同時に出陣し曹操を撃破",},
        [171] = {205005,"泣き面に蜂","劉備と孫尚香が同時に出陣し周瑜を撃破",},
        [172] = {211001,"鳳儀亭","あと残っているのは呂布、董卓、貂蝉だけだ",},
        [173] = {212002,"三英戦呂布","味方は劉関張のみ、敵は呂布のみが残っています",},
        [174] = {221001,"美女の縁","甄姫、黄月英、孫尚香、大小喬、貂蝉が同時に出陣",},
        ...
        [179] = {401001,"持久戦","10ターン以内に決着がつかなかった",},
        [180] = {402002,"朝飯前","最初の攻撃で敵6人を全滅させる",},
        [181] = {501001,"幽冥誅仙刃","武将(金)・司馬昭の初回獲得時に、R25の専用金色神器がもらえる。",},
        [182] = {502001,"蒼松水韻琴","武将(金)・水鏡の初回獲得時に、R25の専用金色神器がもらえる。",},
        [183] = {503001,"烈炎虹凰刀","武将(金)・周姫の初回獲得時に、R25の専用金色神器がもらえる。",},
        [184] = {504001,"延陽追魂杖","武将(金)・南華の初回獲得時に、R25の専用金色神器がもらえる。",},
        [185] = {501002,"千葉流霜刀","武将(金)・王異の初回獲得時に、R25の専用金色神器がもらえる。",},
        [186] = {502002,"神迅霊牛","武将(金)・諸葛果の初回獲得時に、R25の専用金色神器がもらえる。",},
        [187] = {503002,"秘光幻玉剣","武将(金)・陸抗の初回獲得時に、R25の専用金色神器がもらえる。",},
        [188] = {504002,"軽雲の煙管","武将(金)・盧植の初回獲得時に、R25の専用金色神器がもらえる。",},
        [189] = {501003,"璇玑鎮魂灯","武将(金)・管輅の初回獲得時に、R25の専用金色神器がもらえる。",},
        [190] = {502003,"霊霄穿雲槍","武将(金)・馬雲禄の初回獲得時に、R25の専用金色神器がもらえる。",},
        [191] = {503003,"十方青玉刃","武将(金)・朱桓の初回獲得時に、R25の専用金色神器がもらえる。",},
        [192] = {504003,"霊巫破魔斧","武将(金)・木鹿大王の初回獲得時に、R25の専用金色神器がもらえる。",},
        [193] = {501004,"鬼霊奇韫筆","武将(金)・周不疑の初回獲得時に、R25の専用金色神器がもらえる。",},
        [194] = {502004,"百鳥朝鳳槍","武将(金)・童淵の初回獲得時に、R25の専用金色神器がもらえる。",},
        [195] = {503004,"仙蝶鳳箜篌","武将(金)・孫姫の初回獲得時に、R25の専用金色神器がもらえる。",},
        [196] = {504004,"寒冥破星槌","武将(金)・董白の初回獲得時に、R25の専用金色神器がもらえる。",},
    },
