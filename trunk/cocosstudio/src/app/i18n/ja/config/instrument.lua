...
local instrument = {
    ...
    -- data
    _data = {
        [1] = {1,"裂天龍胆槍","龍胆宝石を装着した玄鉄の長槍は非常に強力で、裂天の力を持つ","男主人公","奥義の与えダメージ+25%","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        [2] = {2,"唯我鳴鴻刀","黄帝が鍛えたと伝わる宝刀。この上なく豪奢で刀身は鋭く、鉄も難なく斬れる","女主人公","奥義の与えダメージ+25%","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        ...
        [9] = {107,"絶情断魂鎌","張春華は生涯 司馬懿から離れなかった。無情のように見えてじつは情け深く、ずっと愛に苦しんだ。この剣は母子の剣で、敵と対峙すると防ぐことが困難であるほど様々に変幻する","張春華","奥義の与えダメージ+25%","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        ...
        [14] = {112,"洛神の砕雲鞭","この鞭には仕掛けがあり、トゲの出し入れが可能なため、攻守ともに様々な使い方ができる。その千変万化の様は洛神が舞うようでもあり、霊蛇が這い出てくるようでもあり、人の目をくらませる","甄姫","奥義の直接ダメージの50%をHPに変換し、HPが最も少ない味方を回復する","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        [15] = {113,"狼牙流星錘","この流星錘は途方もない武器。全体に鈎があり、威力抜群。万兵に囲まれても一振りで数人をなぎ倒す","許褚","通常攻撃の直接ダメージの50%を回復に変換し、自身を回復する","0","0","0",},
        ...
        [19] = {117,"悪来の双戟","典韋の双戟は重さ80斤で非常にどっしりしており、1人で敵10人は防げる。勇猛さは虎を谷川に追い詰めるほどで無双","典韋","奥義直接ダメージの40%をHPに変換し、HP最少の味方を回復する","0","0","0",},
        [20] = {118,"魚腸剣","伝説ではこの魚腸剣は刀鍛冶の欧冶子によって作られ、後に辛憲英が偶然に手に入れた。敵がどんな甲冑を着込んでいても、魚腸剣は一撃で突き破れる","辛憲英","シールドのダメージ軽減比率が45%に上昇","0","0","0",},
        [21] = {119,"疾風の刃","疾風剣豪の剣、疾風剣豪の羽織、疾風剣豪の熟年スタイルだ～","于禁","受けた奥義直接ダメージの20%をHPに変換し、自身を回復する","0","0","0",},
        ...
        [23] = {202,"雌雄双股剣","1振りは青、もう1振りは紫の剣。それぞれ青龍と紫龍が変化したもので、所有者は九五之尊(帝王の位)に就けるといわれている。また、双股剣を融合させて1振りの大剣にすると、天地の精髄を引き寄せ、仁徳を広めることができる","劉備","受けた直接ダメージの18%をHPに変換し、味方全員を回復する","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        ...
        [25] = {204,"木牛流馬","胴は四角く頭は丸みを帯び、4本の脚がある。胴から頭が出ていて、舌は胴と繋がっている。荷を多く積むとあまり進めないが、屈強な者なら数十里進める。2本の轅で牛を支え、人が6尺進めば、牛は四歩進む","黄月英","奥義発動後、全味方の怒気を1pt回復する","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        ...
        [39] = {218,"龍鱗刀","関銀屏の偃月長刀製作で余った素材で作られたといわれる。仕方ない、我らが武聖も自分の娘は可愛いかったのだろう","関平","奥義の与えるダメージ+15%","0","0","0",},
        [40] = {219,"騰蛇の法杖","絡まり合う三匹の金蛇の形状を持つ法杖。一目見ただけで法正に幻惑され、身動きができなくなるらしい","法正","麻痺効果の付加率が70%に上昇","0","0","0",},
        [41] = {301,"金龍神鐧","孫策の双鐗は古代の神器を用いて鍛えられたもので、仕掛けを内蔵しており、変形させて鉄拳にすることができる。その巧妙さは、小覇王・孫策の蓋世の英姿を物語っている","孫策","攻撃時、やけど状態のターゲットに対する会心率+80%","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        [42] = {302,"蓮花幽傘","傘骨には瀟湘の翠竹、柄には泰山の欅が使われ、傘表には九華粉で蓮が描かれている傘で、霊気を秘めている。霊気が満ちると、驚くほど軽快に飛ぶことができ、目も心も楽しませてくれる","大喬","奥義発動後、味方に与える持続回復効果が大喬の攻撃力の32%に上昇","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        ...
        [44] = {304,"星華双扇","扇骨は金、扇面は絹でできており、豪奢な中にも雅びさと使いやすさを併せ持つ。持ち主同様しなやかな佇まいで素早く人を襲う様は、この上なく秀麗","小喬","奥義発動後、HP最少の味方武将2名に無敵の吸血シールドを付与する。持続1ターン","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        ...
        [55] = {315,"黄玉の笏","怖いか?私が手にしている黄玉の笏が。受けてみろ、この怒れる者の口撃を","張昭","シールドが自身に対する直接ダメージをすべて吸収するようになる","0","0","0",},
        ...
        [61] = {402,"天枢杖","華佗の友人の左慈が蟠桃の木枝から作った法杖。山登り、薬草採集では杖として道案内をし、診療所では薬としてHPを回復する","華佗","自身のHPが10%減るごとに、受ける回復量+5%","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        ...
        [63] = {404,"仙女の蓮華","天地の霊気を秘めた蓮の花。非常に気品があり、この上なく優美","貂蝉","奥義直接ダメージの50%をHPに変換し、HP最少の味方を回復させる","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        [64] = {405,"魔王の鈎爪","洛陽を炎上させ、最も気概のあった者の頭蓋骨を七星宝刀で削り出して作られた鈎爪。これを繰り出せば、必ず敵を仕留められる","董卓","シールドのダメージ軽減比率が50%に上昇","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        ...
        [75] = {416,"龍泉剣","世の転変の激しさに飽いた古代の宝剣。お前が明君か忠臣か、邪悪な輩か梟雄かに関わらず、能力があるなら斬り、ないなら罵る。私はただ剣であり続けるだけだ","陳宮","奥義の与えるダメージ+15%","0","0","0",},
        [76] = {417,"春駒","幼いころ兄弟に梨を譲ってあげたことで、小さな竹馬が孔融の武器となった。孔子の子孫だとか、漢末の諸侯だとか、どうでもいい","孔融","通常攻撃後に自身の怒気を1pt追加回復する","0","0","0",},
        [77] = {418,"飛雲槍","公孫瓚は騎兵3千を率い、遼西烏桓を降した。烏桓の首領・貪至王は部族を率いて公孫瓚に投降し、この槍を献上した。名を飛雲槍という","公孫瓚","通常攻撃ダメージの50%をHPに変換し、自身を回復する","0","0","0",},
        ...
        [81] = {152,"璇玑鎮魂灯","目立たない灯が、日月星辰を吸収し、無窮な力に化す","管輅","奥義発動後、自身の怒気+2pt、間接ダメージでターゲットを倒したら、更に怒気+2pt","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        ...
        [87] = {350,"烈炎虹凰刀","宝刀には鳳凰の魂が凝縮されており、赤い蓮華が花開くと、火を浴びて再生するという","周姫","奥義の攻撃ターゲットが男性武将の場合は最大HP10%分の追加ダメージを与え、女性武将の場合は、HP最少の味方ターゲット2名の制御効果を解消する","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
        [88] = {351,"秘光幻玉剣","貴重な金糸と玉でできた宝剣。美しき玉は適度に滑らかで、その発する光が自在に流動している","陸抗","毎ターン怒気を2pt回復。奥義発動後、味方武将に付与するアーマー効果が20%に上昇","初期怒気+1","初期怒気+1","開始時に最大HP18%のアーマーを付加",},
