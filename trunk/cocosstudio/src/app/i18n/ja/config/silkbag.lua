...
local silkbag = {
    ...
    _data = {
        ...
        [4] = {1104,"錦袋[公孫瓚]","会心率+8%","会心率+8%","会心率+8%","着用",},
        [5] = {1105,"錦袋[黄盖]","会心阻止率+8%","会心阻止率+8%","会心阻止率+8%","着用",},
        [6] = {1106,"錦袋[張譲]","ダメージ+5%","ダメージ+5%","ダメージ+5%","着用",},
        [7] = {1107,"錦袋[賈詡]","ダメージ軽減+5%","ダメージ軽減+5%","ダメージ軽減+5%","着用",},
        ...
        [11] = {1204,"錦袋[呂霊雎]","単体ターゲットを攻撃し、怒気-1pt","単体ターゲット攻撃時、ターゲットの怒気-1pt。","敵単体を攻撃し、その怒気-1pt。","着用",},
        ...
        [14] = {1208,"錦袋[蔡文姫]","中毒確率上昇","攻撃ターゲットが少ないほど、中毒確率が上昇する(最大60%)。","中毒確率上昇","着用",},
        [15] = {1209,"錦袋[徐庶]","めまい確率上昇","イベント期間中、累計チャージが一定額に達すると、たくさんの報酬がすぐ手に入ります。注: イベント期間終了後も未受領の報酬は失われます。","めまい確率上昇","着用",},
        ...
        [25] = {1220,"錦袋[張春華]","ダメージ+12%","ダメージ+12%","ダメージ+12%","着用",},
        [26] = {1221,"錦袋[董卓]","ダメージ軽減+12%","ダメージ軽減+12%","ダメージ軽減+12%","着用",},
        [27] = {1222,"錦袋[孫尚香]","会心ダメージ+12%","会心ダメージ+12%","会心ダメージ+12%","着用",},
        [28] = {1223,"錦袋[王元姫]","ターゲットを倒すと自身の怒気を1pt回復","目標を撃破すると、自身の怒気を1pt回復する。","ターゲットを倒すと自身の怒気を1pt回復","着用",},
        ...
        [38] = {1309,"神錦袋[陸遜]","やけど状態の武将の無敵封印","やけど状態の武将は無敵や無敵の吸血シールド効果を獲得できません。","やけど状態の武将は無敵効果を得られない","着用",},
        ...
        [41] = {1312,"錦袋[司馬懿]","怒気をすべて消費すると、奥義ダメージが増加","武将の怒気が7pt以下の場合、奥義を発動しない。奥義発動時にすべての怒気を消費し、4ptを超えた怒気は1ptにつき、奥義のダメージ+8%","怒気をすべて消費すると、奥義ダメージが増加","着用",},
        [42] = {1305,"神錦袋[蔡文姫]","中毒持続ターン数増加","奥義による中毒状態を1ターン延長。","中毒状態を1ターン追加","着用",},
        [43] = {1313,"神錦袋[荀彧]","奥義発動で回復量が上昇","回復武将が奥義発動時、HPが最も少ない味方武将3人の回復効果が回復武将の攻撃力の32%まで上がる。","奥義発動で回復量が上昇","着用",},
        [44] = {1314,"錦袋[桃園の誓い]","受けたダメージを分担","被ダメージ-12%、かつ自身の受ける非致命的ダメージを、自身およびHP最大の味方武将2名と等分する(ダメージ分担時は無敵状態の武将もダメージを受ける)","受けたダメージを分担","着用",},
        ...
        [48] = {1318,"錦袋[単騎千里]","その時点でHP最少の敵武将を攻撃する","単体攻撃タイプの武将の全攻撃が現在HPが最も少ない武将を優先して攻撃する。","その時点でHP最少の敵武将を攻撃する","着用",},
        [49] = {1319,"錦袋[一騎当千]","目標を撃破すると奥義1回追加","単体攻撃武将がターゲットを倒すと、奥義を1回追加し、敵単体に175%の物理ダメージを与える(追加された奥義は怒気を消費せず、何の特性も付かない)","目標を撃破すると奥義1回追加","着用",},
        [50] = {1320,"錦袋[一枚上手]","味方死亡時に与ダメージが上昇","攻撃時、ダメージ＋9%(味方武将が敵より一人多くにつれダメージ＋4.5%)","攻撃時、ダメージ上昇","着用",},
        ...
        [53] = {1402,"錦袋[貪狼]","目標を撃破すると怒気を獲得。","奥義が敵ターゲットを倒した場合、ターゲットに残っていた怒気を全て獲得(火力武将に装備可能)","敵ターゲットを倒したら、ターゲットの怒気を獲得","着用",},
