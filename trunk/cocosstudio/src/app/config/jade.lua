...
local __key_type = {
  ...
  treasure_type = "int",    --适用宝物类型-8 
  treasure = "string",    --适用宝物-9 
  profile = "string",    --玉石短描述-10 
  description = "string",    --玉石详情-11 
  type = "int",    --属性1类型-12 
  size = "int",    --属性1数值-13 
  growth = "int",    --属性1成长-14 
  fake = "int",    --假战力-15 
  bag_description = "string",    --背包玉石描述-16 
  button_type = "int",    --按钮类型-17 
  function_id = "int",    --跳转功能id-18 
  button_txt = "string",    --按钮文字-19 
  recycle_type = "int",    --回收资源货币类型-20 
  recycle_value = "int",    --回收资源货币名称-21 
  recycle_size = "int",    --回收资源货币数量-22 
  effect = "string",    --特效-23 
  sort = "int",    --排序-24 
  hero = "string",    --适用武将-25 
...
local jade = {
    ...
    _data = {
        ...
        [28] = {1304,"青龙日耀玉·克",1304,6,2,1,"601|501|409",0,"","PVP增伤+4%","PVP增伤+4%",46,180,0,1200000,"PVP增伤+4%",1,131,"镶 嵌",5,30,3200,"effect_shuijing_lan3up|effect_shuijing_lan3down",16,"999",},
        ...
        [32] = {1308,"玄武日耀玉·韧",1308,6,2,2,"602|502|410",0,"","PVP减伤+4%","PVP减伤+4%",47,180,0,1200000,"PVP减伤+4%",1,131,"镶 嵌",5,30,3200,"effect_shuijing_lv3up|effect_shuijing_lv3down",12,"999",},
        ...
        [36] = {1312,"白虎日耀玉·韧",1312,6,2,3,"603|503|411",0,"","PVP减伤+4%","PVP减伤+4%",47,180,0,1200000,"PVP减伤+4%",1,131,"镶 嵌",5,30,3200,"effect_shuijing_huang3up|effect_shuijing_huang3down",8,"999",},
        ...
        [40] = {1316,"朱雀日耀玉·克",1316,6,2,4,"604|504|412",0,"","PVP增伤+4%","PVP增伤+4%",46,180,0,1200000,"PVP增伤+4%",1,131,"镶 嵌",5,30,3200,"effect_shuijing_red3up|effect_shuijing_red3down",4,"999",},
...
local mt = { 
    __index = function(t, k) 
        ...
        assert(key_map[k], "cannot find " .. k .. " in jade")
...
--
function jade.isVersionValid(v)
    if jade.version then
        if v then
            return jade.version <= v
        else
            return false
        end
    else
...
function jade.indexOf(index)
    ...
    if Lang.lang ~= _lang then 
        ...
        if Lang.lang ~= "cn" then
            _isDataExist = Lang.isFileExist("app/i18n/".. _lang .."/data/jade.lua")
            _isExist = Lang.isFileExist("app/i18n/".. _lang .."/config/jade.lua")
            _isBaseExist =  Lang.isFileExist("app/i18n/".. _lang .."/base/jade.lua")

            if _isDataExist then
                local table = require( "app.i18n.".. _lang ..".data." .. "jade" )
                _isDataExist = jade.isVersionValid(table.version)
            end
            if _isBaseExist then
                local table = require( "app.i18n.".. _lang ..".base." .. "jade" )
                _isBaseExist = jade.isVersionValid(table.version)
            end
            if _isExist then
                local table = require( "app.i18n.".. _lang ..".config." .. "jade" )
                _isExist = jade.isVersionValid(table.version)
            end
        end
    end
    ...
    config._raw = jade._data[index]
    if _lang ~= "cn" and _isBaseExist then
        local table_base = require( "app.i18n.".. _lang ..".base." .. "jade" )
