...
local mt = { 
    __index = function(t, k) 
        ...
        assert(key_map[k], "cannot find " .. k .. " in hero_skill_effect")
...
--
function hero_skill_effect.isVersionValid(v)
    if hero_skill_effect.version then
        if v then
            return hero_skill_effect.version <= v
        else
            return false
        end
    else
...
function hero_skill_effect.indexOf(index)
    ...
    if Lang.lang ~= _lang then 
        ...
        if Lang.lang ~= "cn" then
            _isDataExist = Lang.isFileExist("app/i18n/".. _lang .."/data/hero_skill_effect.lua")
            _isExist = Lang.isFileExist("app/i18n/".. _lang .."/config/hero_skill_effect.lua")
            _isBaseExist =  Lang.isFileExist("app/i18n/".. _lang .."/base/hero_skill_effect.lua")

            if _isDataExist then
                local table = require( "app.i18n.".. _lang ..".data." .. "hero_skill_effect" )
                _isDataExist = hero_skill_effect.isVersionValid(table.version)
            end
            if _isBaseExist then
                local table = require( "app.i18n.".. _lang ..".base." .. "hero_skill_effect" )
                _isBaseExist = hero_skill_effect.isVersionValid(table.version)
            end
            if _isExist then
                local table = require( "app.i18n.".. _lang ..".config." .. "hero_skill_effect" )
                _isExist = hero_skill_effect.isVersionValid(table.version)
            end
        end
    end
    ...
    if _lang ~= "cn" and _isDataExist then
		...
		local index_key = "__index_buff_type"
    ...
    config._raw = hero_skill_effect._data[index]
    if _lang ~= "cn" and _isBaseExist then
        local table_base = require( "app.i18n.".. _lang ..".base." .. "hero_skill_effect" )
