...
local mt = { 
    __index = function(t, k) 
        ...
        assert(key_map[k], "cannot find " .. k .. " in horse_star")
...
--
function horse_star.isVersionValid(v)
    if horse_star.version then
        if v then
            return horse_star.version <= v
        else
            return false
        end
    else
...
function horse_star.indexOf(index)
    ...
    if Lang.lang ~= _lang then 
        ...
        if Lang.lang ~= "cn" then
            _isDataExist = Lang.isFileExist("app/i18n/".. _lang .."/data/horse_star.lua")
            _isExist = Lang.isFileExist("app/i18n/".. _lang .."/config/horse_star.lua")
            _isBaseExist =  Lang.isFileExist("app/i18n/".. _lang .."/base/horse_star.lua")

            if _isDataExist then
                local table = require( "app.i18n.".. _lang ..".data." .. "horse_star" )
                _isDataExist = horse_star.isVersionValid(table.version)
            end
            if _isBaseExist then
                local table = require( "app.i18n.".. _lang ..".base." .. "horse_star" )
                _isBaseExist = horse_star.isVersionValid(table.version)
            end
            if _isExist then
                local table = require( "app.i18n.".. _lang ..".config." .. "horse_star" )
                _isExist = horse_star.isVersionValid(table.version)
            end
        end
    end
    ...
    config._raw = horse_star._data[index]
    if _lang ~= "cn" and _isBaseExist then
        local table_base = require( "app.i18n.".. _lang ..".base." .. "horse_star" )
