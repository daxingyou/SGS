...
local mt = { 
    __index = function(t, k) 
        ...
        assert(key_map[k], "cannot find " .. k .. " in treasure_refine")
...
--
function treasure_refine.isVersionValid(v)
    if treasure_refine.version then
        if v then
            return treasure_refine.version <= v
        else
            return false
        end
    else
...
function treasure_refine.indexOf(index)
    ...
    if Lang.lang ~= _lang then 
        ...
        if Lang.lang ~= "cn" then
            _isDataExist = Lang.isFileExist("app/i18n/".. _lang .."/data/treasure_refine.lua")
            _isExist = Lang.isFileExist("app/i18n/".. _lang .."/config/treasure_refine.lua")
            _isBaseExist =  Lang.isFileExist("app/i18n/".. _lang .."/base/treasure_refine.lua")

            if _isDataExist then
                local table = require( "app.i18n.".. _lang ..".data." .. "treasure_refine" )
                _isDataExist = treasure_refine.isVersionValid(table.version)
            end
            if _isBaseExist then
                local table = require( "app.i18n.".. _lang ..".base." .. "treasure_refine" )
                _isBaseExist = treasure_refine.isVersionValid(table.version)
            end
            if _isExist then
                local table = require( "app.i18n.".. _lang ..".config." .. "treasure_refine" )
                _isExist = treasure_refine.isVersionValid(table.version)
            end
        end
    end
    ...
    config._raw = treasure_refine._data[index]
    if _lang ~= "cn" and _isBaseExist then
        local table_base = require( "app.i18n.".. _lang ..".base." .. "treasure_refine" )
