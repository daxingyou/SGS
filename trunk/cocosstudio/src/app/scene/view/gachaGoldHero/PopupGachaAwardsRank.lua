...
function PopupGachaAwardsRank:_updateDesc()
    ...
    if Lang.checkUI("ui4") then  -- i18n ja change
        if self._selectTabIdx == 2 then 
            self._textCountDown:ignoreContentAdaptWithSize(false)
            self._textCountDown:setAnchorPoint(cc.p(0, 1))
            self._textCountDown:setPositionY(52) 
            self._textCountTime:setPosition(337-45, 51) 
        elseif self._selectTabIdx == 1 then   
            self._textCountDown:setAnchorPoint(cc.p(0, 1))
            self._textCountDown:setPositionY(51) 
            self._textCountDown:ignoreContentAdaptWithSize(true)
            self._textCountDown:setTextAreaSize(cc.size(903, 0)) 
            self._textCountTime:setPosition(158-65-20, 29)
        end  
    else  
...
-- i18n pos lable
function PopupGachaAwardsRank:_updateHelpPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		logWarn("_-----------------_")
    ...
    if Lang.checkLang(Lang.JA) then -- i18n ja change
         self._scrollView:setContentSize(cc.size(942, 300))
         self._scrollView:setPositionY(45)
        ...
        --  self._textCountDown:setTextAreaSize(cc.size(903, 0)) 
         ...
         self._textCountTime:setAnchorPoint(cc.p(0, 1))
         self._textCountTime:setPositionY(52)  

         self._textCountDesc:setAnchorPoint(cc.p(0, 1))
         self._textCountDesc:setPositionY(5) 
         self._textCountDesc:ignoreContentAdaptWithSize(true)
         self._textCountDesc:setTextAreaSize(cc.size(903, 0)) 
    end 
...
-- i18n pos lable
function PopupGachaAwardsRank:_dealPosByI18n()
end
