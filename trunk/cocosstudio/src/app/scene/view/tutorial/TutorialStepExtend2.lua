...
TutorialStepExtend.step302 =  TutorialStepHelper.buildMainIconGoTable2(
	"commonMain"..FunctionConst.FUNC_TEAM, FunctionConst.FUNC_TEAM)

-- i18n ja
TutorialStepExtend.step303 = TutorialStepHelper.buildTeamViewPosTable(3)
...
TutorialStepExtend.step602 =  TutorialStepHelper.buildMainIconGoTable2(
	"commonMain"..FunctionConst.FUNC_TEAM, FunctionConst.FUNC_TEAM)

TutorialStepExtend.step603 = TutorialStepHelper.buildTeamViewPosTable(3)
...
TutorialStepExtend.step604 =
{
	...
	findfunc = function(nodeName)
		...
		local clickWidget = root:getSubNodeByName("_panelMid")
		return clickWidget:getBoundingBox()
	end,
	clickfunc = function(sender, stepData)
...
TutorialStepExtend.step605 =
{
	...
	findfunc = function(nodeName)
		local root = nil
		root = display.getRunningScene():getSubNodeByName("HeroDetailBaseView")
		local clickWidget = root:getSubNodeByName("_buttonUpgrade")
		return clickWidget:getCascadeBoundingBox()
	end,

	clickfunc = function(sender, stepData)
		local root = display.getRunningScene():getSubNodeByName("HeroDetailBaseView")
...
TutorialStepExtend.step606=
{
	simulate = true,
	findfunc = function(nodeName) 
		if not Lang.checkUI("ui4") then -- i18n ja change 
			local clickWidget = display.getRunningScene():getSubNodeByName("_buttonUpgradeFive")
			return clickWidget:getCascadeBoundingBox()
		else  
			local _listView =  display.getRunningScene():getSubNodeByName("HeroDetailBaseView")  
			_listView = _listView:getSubNodeByName("_listView")
			_listView:requestDoLayout()
			_listView:doLayout()
			local clickWidget = display.getRunningScene():getSubNodeByName("HeroTrainUpgradeLayer")
			clickWidget = clickWidget:getSubNodeByName("_buttonUpgradeFive")
			return clickWidget:getCascadeBoundingBox()  
		end	
	end,
...
--点击阵容3号位
TutorialStepExtend.step902 = TutorialStepHelper.buildMainIconGoTable2(
	"commonMain"..FunctionConst.FUNC_TEAM, FunctionConst.FUNC_TEAM)
...
TutorialStepExtend.step903=
{
	...
	clickfunc = function(sender, stepData)
		local root,teamPageItem = display.getRunningScene():getSubNodeByName("TeamView"):getCurHeroSpine()
		if teamPageItem._onClickAvatar then
			teamPageItem:_onClickAvatar()
		end
		G_TutorialManager:clearTipLayer()
	end,
...
TutorialStepExtend.step904=
{
	...
	clickfunc = function(sender, stepData)  
		if not Lang.checkUI("ui4") then -- i18n ja change 
			...
			local root = display.getRunningScene():getSubNodeByName("HeroDetailBaseView")
			root:_onButtonBreakClicked()
			--G_TutorialManager:clearTipLayer() bug:会导致清空子节点
		end
...
TutorialStepExtend.step905=
{
	...
	findfunc = function(nodeName)
		...
		_listView:requestDoLayout()
		_listView:doLayout()
		local root = display.getRunningScene():getSubNodeByName("HeroTrainBreakLayer")
		root = root:getSubNodeByName("_imageTalentBg")
		return root:getCascadeBoundingBox()
	end,
	clickfunc = function(sender, stepData)
		stepData.doNextStep()
...
TutorialStepExtend.step906=
{
	...
	findfunc = function(nodeName)
		if not Lang.checkUI("ui4") then -- i18n ja change 
			...
			_listView:doLayout()
			local root = display.getRunningScene():getSubNodeByName("HeroTrainBreakLayer")
			root = root:getSubNodeByName("_buttonBreak")
			return root:getCascadeBoundingBox()  
		end
	end,
	clickfunc = function(sender, stepData)
...
--点击男主
TutorialStepExtend.step1306 = TutorialStepHelper.buildMainIconGoTable2(
	"commonMain"..FunctionConst.FUNC_TEAM, FunctionConst.FUNC_TEAM)
--点击缘分
...
--点击男主
TutorialStepExtend.step1502 = TutorialStepHelper.buildMainIconGoTable2(
	"commonMain"..FunctionConst.FUNC_TEAM, FunctionConst.FUNC_TEAM)
...
TutorialStepExtend.step1604=
{
	simulate = true,
	findfunc = function(nodeName)
		local root = display.getRunningScene():getSubNodeByName("_buttonStreng")
		return root:getCascadeBoundingBox()
	end,
	clickfunc = function(sender, stepData)  
		local root = display.getRunningScene():getSubNodeByName("EquipDetailBaseView")
		root:_onButtonStrengClicked()
		-- G_TutorialManager:clearTipLayer() --bug:会导致清空子节点
	end,
}
--点击强化
...
--点击男主
TutorialStepExtend.step2004 = TutorialStepHelper.buildMainIconGoTable2(
	"commonMain"..FunctionConst.FUNC_TEAM, FunctionConst.FUNC_TEAM)
...
TutorialStepExtend.step2104 ={
	...
	clickfunc = function(sender, stepData)  
		local root = display.getRunningScene():getSubNodeByName("TreasureDetailBaseView")
		root:_onButtonStrengClicked()
		-- G_TutorialManager:clearTipLayer() --bug:会导致清空子节点
	end,
}
...
--=============================================================================
--领地巡逻引导
TutorialStepExtend.step7801 = TutorialStepHelper.buildNewFunctionSceneTable()
TutorialStepExtend.step7802 = TutorialStepHelper.buildNewFunctionDlgTable(FunctionConst.FUNC_PVE_TERRITORY)
TutorialStepExtend.step7803 =  TutorialStepHelper.buildNewFunctionBtnTable()
--点击冒险
TutorialStepExtend.step7804 =  TutorialStepHelper.buildMainIconGoTable("commonMain"..FunctionConst.FUNC_ADVENTURE, FunctionConst.FUNC_ADVENTURE)
--点击领地巡逻
TutorialStepExtend.step7805 = TutorialStepHelper.buildChallengeCellTable(FunctionConst.FUNC_PVE_TERRITORY)

--弱引导
TutorialStepExtend.step7806 = {
	simulate = true,
	findfunc = function(nodeName)
		local root = display.getRunningScene():getSubNodeByName("TerritoryView")
		local city = root:getSubNodeByName("Node_1")
		return city:getSubNodeByName("_panelContainer"):getCascadeBoundingBox()
	end,
	clickfunc = function(sender, stepData)
		local root = display.getRunningScene():getSubNodeByName("TerritoryView")
		root._territoryCityNode[1]:_onPanelClick()
		stepData.doNextStep()
	end,
}
...
-- i18n ja 南蛮新增
TutorialStepExtend.step8101 = {
	func = function(stepData)
		local sceneName = display.getRunningScene():getName()
		if sceneName == "siege" then
			stepData.doNextStep()
		elseif sceneName ~= "fight" then
			G_SceneManager:popToRootAndReplaceScene("siege")
		end
	end
}
...
-- i18n ja 南蛮新增
TutorialStepExtend.step8102 = {
	simulate = true, --模拟点击
	findfunc = function(nodeName)
		local target = display.getRunningScene():getSubNodeByName("_btnShop")
		return target:getCascadeBoundingBox()
	end,
	clickfunc =  function(sender, stepData)
		local SiegeView = display.getRunningScene():getSubNodeByName("SiegeView")
		SiegeView:_onShopClick()
		stepData.doNextStep()
	end,
}
...
--点击主角
TutorialStepExtend.step9005 = TutorialStepHelper.buildMainIconGoTable2(
	"commonMain"..FunctionConst.FUNC_TEAM, FunctionConst.FUNC_TEAM)
...
---------------------------------------------------------------------------
---------------------------------------------------------------------------
-- TutorialStepExtend.step2401 = {
-- 	func = function( ... )
-- 		G_SceneManager:popToRootAndReplaceScene("main")
-- 	end
-- }
TutorialStepExtend.step2401 = TutorialStepHelper.buildNewFunctionSceneTable()

TutorialStepExtend.step2402 =  TutorialStepHelper.buildMainIconGoTable2(
	"commonMain"..FunctionConst.FUNC_TEAM, FunctionConst.FUNC_TEAM)

-- i18n ja
TutorialStepExtend.step2403 = TutorialStepHelper.buildTeamViewPosTable(4)

--点击上阵
TutorialStepExtend.step2404 =
{
	simulate = true,
	findfunc = function()
		local chooseHero = display.getRunningScene():getSubNodeByName("PopupChooseHero")
	...
	clickfunc =  function(sender, stepData)
		logNewT("TutorialStepExtend.step2404")
		local chooseHero = display.getRunningScene():getSubNodeByName("PopupChooseHero")
		local listView = chooseHero:getSubNodeByName("_listView")
		local itemList = listView:getChildren()
		local cellWidget = itemList[1]
...
--点击任意区域
TutorialStepExtend.step2405 =
{
	simulate = true, --模拟点击
}


TutorialStepExtend.step2406 =
{
	simulate = true, --模拟点击
	findfunc = function(nodeName)
		return TutorialStepHelper.findBackButton()
...
TutorialStepExtend.step2407 = TutorialStepHelper.buildMainIconGoTable("_btnMainFight", FunctionConst.FUNC_NEW_STAGE)

--新增合击将引导
--程序处理
TutorialStepExtend.step3301 = TutorialStepHelper.buildNewFunctionSceneTable()

--弹出新武将合击礼包界面
TutorialStepExtend.step3302 = TutorialStepHelper.buildPopupComboGiftTable()
--点击确认
TutorialStepExtend.step3303 = {
	simulate = true,
	findfunc = function(nodeName)
		local root = display.getRunningScene():getSubNodeByName("_commonBtn")
		return root:getCascadeBoundingBox()
...
--剧情阶段
TutorialStepExtend.step3304 ={}

TutorialStepExtend.step3305 = TutorialStepHelper.buildMainIconGoTable(
	"commonMain"..FunctionConst.FUNC_ITEM_BAG, FunctionConst.FUNC_ITEM_BAG)

--点击使用
TutorialStepExtend.step3306 = {
	simulate = true,
	findfunc = function(nodeName)
		local chooseHero = display.getRunningScene():getSubNodeByName("PackageView")
		local listView = chooseHero:getSubNodeByName("_listViewTab1")
...
TutorialStepExtend.step3307 = TutorialStepHelper.buildPopupGetRewardsTable()--点击确认
--点击返回
TutorialStepExtend.step3308 ={
	simulate = true,
	findfunc = function(nodeName)
		return TutorialStepHelper.findBackButton()
	end,
...
---------------------------------------------------------------------------
-- TutorialStepExtend.step3401 = {
-- 	func = function( ... )
-- 		G_SceneManager:popToRootAndReplaceScene("main")
-- 	end
-- }

TutorialStepExtend.step3401 = TutorialStepHelper.buildNewFunctionSceneTable()

TutorialStepExtend.step3402 =  TutorialStepHelper.buildMainIconGoTable2(
	"commonMain"..FunctionConst.FUNC_TEAM, FunctionConst.FUNC_TEAM)

-- i18n ja
TutorialStepExtend.step3403 = TutorialStepHelper.buildTeamViewPosTable(5)

--点击上阵
TutorialStepExtend.step3404 =
{
	simulate = true,
	findfunc = function()
		local chooseHero = display.getRunningScene():getSubNodeByName("PopupChooseHero")
	...
	clickfunc =  function(sender, stepData)
		logNewT("TutorialStepExtend.step3404")
		local chooseHero = display.getRunningScene():getSubNodeByName("PopupChooseHero")
		local listView = chooseHero:getSubNodeByName("_listView")
		local itemList = listView:getChildren()
		local cellWidget = itemList[1]
...
--点击任意区域
TutorialStepExtend.step3405 =
{
	simulate = true, --模拟点击
}
---------------------------------------------------------------------------
TutorialStepExtend.step3501 = {
	func = function(stepData)
		local runningScene =  display.getRunningScene()
		if runningScene:getName() ~= "team" then
			G_SceneManager:popToRootAndReplaceScene("team")
		else
			stepData.doNextStep()
		end
...
-- i18n ja
TutorialStepExtend.step3502 = TutorialStepHelper.buildTeamViewPosTable(6)

--点击上阵
TutorialStepExtend.step3503 =
{
	simulate = true,
	findfunc = function()
		local chooseHero = display.getRunningScene():getSubNodeByName("PopupChooseHero")
	...
	clickfunc =  function(sender, stepData)
		logNewT("TutorialStepExtend.step3504")
		local chooseHero = display.getRunningScene():getSubNodeByName("PopupChooseHero")
		local listView = chooseHero:getSubNodeByName("_listView")
		local itemList = listView:getChildren()
		local cellWidget = itemList[1]
