...
--i18 ja 检测武将列表是否有2个可供上阵
function TutorialStageScript.checkStage33(stageObj)
    local heroList = G_UserData:getHero():getReplaceDataBySort()
    if #heroList >= 2 then
        return true
    end
    return false
...
function TutorialStageScript.buildStage3(stageObj)
    ...
    stageObj:addStepData( TutorialStepHelper.createStepDataById(307) )
end

-- i18n ja 根据是否触发合击重建引导步骤
function TutorialStageScript.rebuildStage3(stageObj)
    stageObj:addStepData( TutorialStepHelper.createStepDataById(301) )
    stageObj:addStepData( TutorialStepHelper.createWaitStep(DEFAULT_WAIT_TIME) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(302) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(303) )
    ...
    local heroDatas = G_UserData:getHero():getReplaceDataBySort()
    if heroDatas[1]:isActiveJoint() then
        stageObj:addStepData( TutorialStepHelper.createStepDataById(305) )
    end
...
function TutorialStageScript.buildStage6(stageObj)
    ...
    stageObj:addStepData( TutorialStepHelper.createStepDataById(608) )
end
...
function TutorialStageScript.buildStage9(stageObj)
    for i = 901, 908, 1 do
        -- 删除905弱引导
        if i ~= 905 then
...
function TutorialStageScript.buildStage17(stageObj)
    ...
    -- for i = 1704, 1709, 1 do
    --      stageObj:addStepData( TutorialStepHelper.createStepDataById(i) )
    -- end
    stageObj:addStepData( TutorialStepHelper.createStepDataById(1704) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(1705) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(1706) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(1707) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(1709) )
...
function TutorialStageScript.buildStage78(stageObj)
    stageObj:addStepDataList( TutorialStepHelper.createStageTriggerStep() )
    stageObj:addStepData( TutorialStepHelper.createStepDataById( 7801 ) )
    stageObj:addStepDataList( TutorialStepHelper.createNewFunctionOpenStepList(FunctionConst.FUNC_PVE_TERRITORY) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById( 7804 ) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById( 7805 ) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById( 7806 ) )
end
...
function TutorialStageScript.buildStage81(stageObj)
    stageObj:addStepData( TutorialStepHelper.createStepDataById( 8101 ) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById( 8102 ) )
end

--
function TutorialStageScript.ignoreEvent81( stageObj,eventName )
    local tutorialTipLayer = ccui.Helper:seekNodeByName( G_TopLevelNode,"TutorialTipLayer" )
    if tutorialTipLayer then
        tutorialTipLayer:setTouchRect(cc.rect(0, 0, display.width, display.height))
    end
    local sceneName =  display.getRunningScene():getName()
    local popupSiegeChallenge = ccui.Helper:seekNodeByName( display.getRunningScene(), "PopupSiegeChallenge")
    logNewT("ignoreEvent81 eventName=",eventName,sceneName,popupSiegeChallenge)
    if eventName == "PopupSiegeChallengeExit" and sceneName == "siege" then
        return true
    end
    if eventName == "SeigeView" and popupSiegeChallenge == nil then
        return true
    end
...
-- i18n ja
function TutorialStageScript.buildStage24(stageObj)
    stageObj:addStepData( TutorialStepHelper.createStepDataById(2401) )
    stageObj:addStepData( TutorialStepHelper.createWaitStep(DEFAULT_WAIT_TIME) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(2402) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(2403) )
    stageObj:addStepData( TutorialStepHelper.createEmptyStep() )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(2404) )
    stageObj:addStepData( TutorialStepHelper.createEmptyStep() )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(2405) )

    stageObj:addStepData( TutorialStepHelper.createStepDataById(2406) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(2407) )
end

-- i18n ja 根据是否触发合击重建引导步骤
function TutorialStageScript.rebuildStage24(stageObj)
    stageObj:addStepData( TutorialStepHelper.createStepDataById(2401) )
    stageObj:addStepData( TutorialStepHelper.createWaitStep(DEFAULT_WAIT_TIME) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(2402) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(2403) )
...
-- i18n ja
function TutorialStageScript.buildStage33(stageObj)

    stageObj:addStepDataList( TutorialStepHelper.createStageTriggerStep() )

    stageObj:addStepData( TutorialStepHelper.createStepDataById(3301) )
    --合计将礼包引导
    stageObj:addStepDataList(TutorialStepHelper.createComboHeroStepList2() )

    stageObj:addStepData( TutorialStepHelper.createStepDataById(3304) )

end

-- i18n ja
function TutorialStageScript.buildStage34(stageObj)
    stageObj:addStepData( TutorialStepHelper.createStepDataById(3401) )
    -- stageObj:addStepData( TutorialStepHelper.createWaitStep(DEFAULT_WAIT_TIME) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(3402) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(3403) )
    stageObj:addStepData( TutorialStepHelper.createEmptyStep() )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(3404) )
    stageObj:addStepData( TutorialStepHelper.createEmptyStep() )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(3405) )
end

-- i18n ja 根据是否触发合击重建引导步骤
function TutorialStageScript.rebuildStage34(stageObj)
    stageObj:addStepData( TutorialStepHelper.createStepDataById(3401) )
    -- stageObj:addStepData( TutorialStepHelper.createWaitStep(DEFAULT_WAIT_TIME) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(3402) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(3403) )
...
-- i18n ja
function TutorialStageScript.buildStage35(stageObj)
    stageObj:addStepData( TutorialStepHelper.createStepDataById(3501) )
    -- stageObj:addStepData( TutorialStepHelper.createWaitStep(DEFAULT_WAIT_TIME) )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(3502) )
    stageObj:addStepData( TutorialStepHelper.createEmptyStep() )
    stageObj:addStepData( TutorialStepHelper.createStepDataById(3503) )
end
