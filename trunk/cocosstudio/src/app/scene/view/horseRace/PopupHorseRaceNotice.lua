...
-- i18n change lable
function PopupHorseRaceNotice:_dealI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
        self._reward1:setPositionX(self._reward1:getPositionX()+ 25)
		self._reward2:setPositionX(self._reward2:getPositionX()+ 25)
	end
end
