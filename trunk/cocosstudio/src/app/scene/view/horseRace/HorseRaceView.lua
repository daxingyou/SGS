...
-- i18n change lable
function HorseRaceView:_dealI18n()
	if not Lang.checkLang(Lang.CN) then
		-- i18n ja change name
		if Lang.checkUI("ui4") then   
			self._textPoint:setPositionX(420)
			self._textPoint:setPositionX(self._textPoint:getPositionX()- 23)
			self._textDistance:setPositionX(self._textDistance:getPositionX() + 9)
		else   
			local UIHelper  = require("yoka.utils.UIHelper")
			self._textPoint:setPositionX(self._textPoint:getPositionX()- 23)
			self._textDistance:setPositionX(self._textDistance:getPositionX() + 13)
		end
	end
end
