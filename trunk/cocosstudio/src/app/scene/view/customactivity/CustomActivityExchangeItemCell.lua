...
function CustomActivityExchangeItemCell:_updateRewards(actTaskUnitData)
	...
	if Lang.checkUI("ui4") then
        self._commonItemListExchangeNode:setCountFontSize(16)
	end 
end
...
-- i18n change lable
function CustomActivityExchangeItemCell:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
        ...
        self._imageUnReceive = UIHelper.swapSignImage(self._imageUnReceive,
		{ 
			 style = "signet_5", 
			 text = Lang.getImgText("img_yikaiqi01b") ,
			 anchorPoint = cc.p(0.5,0.5),
			 rotation = -10,
		},Path.getTextSignet("img_common_hui"))
