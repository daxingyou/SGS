...
-- i18n pos lable
function GroupHeroNode:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		self._imageLeaderFlag:setPositionX(self._imageLeaderFlag:getPositionX()-15)
		self._buttonOut:setPositionX(self._buttonOut:getPositionX()+15)

	--	self._imageLeaderFlag:setPositionX(self._textPlayerName:getPositionX()-self._textPlayerName:getContentSize().width*0.5-28)
	--	self._imageLeaderFlag:setPositionX(self._textPlayerName:getPositionX()+self._textPlayerName:getContentSize().width*0.5+28)
	end
