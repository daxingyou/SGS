...
-- i18n change lable
function PopupDailyMissionCell:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")	
		local missionNode1 = self["_fileNode"..1]
		local missionNode2 = self["_fileNode"..2]
		
		local image1 = UIHelper.seekNodeByName(missionNode1,"Image_mission_finish")
		local image2 = UIHelper.seekNodeByName(missionNode2,"Image_mission_finish")

         UIHelper.swapSignImage(image1,
		{ 
			 style = "signet_8", 
