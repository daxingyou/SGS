...
-- 调整英文 泰文位置  -- i18n ja pos lable
function PopupServerList:adjustlabelPos()
	ccui.Helper:seekNodeByName(self._listView:getParent(), "Image_3"):setPositionY(292)
	ccui.Helper:seekNodeByName(self._listView:getParent(), "Text_1"):setFontSize(18)
	ccui.Helper:seekNodeByName(self._listView:getParent(), "Text_2"):setFontSize(18)
	ccui.Helper:seekNodeByName(self._listView:getParent(), "Text_3"):setFontSize(18)
	ccui.Helper:seekNodeByName(self._listView:getParent(), "Text_1"):setPositionX(228)
	ccui.Helper:seekNodeByName(self._listView:getParent(), "Text_3"):setPositionX(445)
end
