...
function EquipMasterProgressNode:_onClickButton()
	...
	if masterType == MasterConst.MASTER_TYPE_1 then
		...
		if Lang.checkUI("ui4") then
			G_SceneManager:showScene("equipmentDetail", self._equipId, EquipConst.EQUIP_RANGE_TYPE_2, EquipConst.EQUIP_TRAIN_STRENGTHEN+1) 
		else  	
	...
	elseif masterType == MasterConst.MASTER_TYPE_2 then
		...
		-- i18n ja change 
		if Lang.checkUI("ui4") then
			G_SceneManager:showScene("equipmentDetail", self._equipId, EquipConst.EQUIP_RANGE_TYPE_2, EquipConst.EQUIP_TRAIN_REFINE+1) 
		else  	
	...
	elseif masterType == MasterConst.MASTER_TYPE_3 then
		...
		-- i18n ja change 
		if Lang.checkUI("ui4") then
			G_SceneManager:showScene("treasureDetail", self._equipId, TreasureConst.TREASURE_RANGE_TYPE_2, TreasureConst.TREASURE_TRAIN_STRENGTHEN+1)
		else  
	...
	elseif masterType == MasterConst.MASTER_TYPE_4 then
		...
		-- i18n ja change 
		if Lang.checkUI("ui4") then  
			G_SceneManager:showScene("treasureDetail", self._equipId, TreasureConst.TREASURE_RANGE_TYPE_2, TreasureConst.TREASURE_TRAIN_REFINE+1)
		else  	
