    ...
    local function effectFunction(effect)
        if effect == "jingying_xiangqing" then
            ...
            if Lang.checkUI("ui4") then
                local btn = UIHelper.seekNodeByName(helpNode,"Button")
                btn:setContentSize(cc.size(24,32))
                btn:loadTextures( Path.getBossComeUI("helpICon"),nil ,nil,0)
            end
        ...
        elseif effect == "jingying_close" then
            ...
            if Lang.checkUI("ui4") then
                params = {
                    texture = Path.getBossComeUI("btn_embattle_close")
                }
            end
        ...
        elseif effect == "jingying_jiantou_copy1" then 
            ...
            if Lang.checkUI("ui4") then
                params = {
                    texture = Path.getBossComeUI("img_com_arrow04")
                }
            end
