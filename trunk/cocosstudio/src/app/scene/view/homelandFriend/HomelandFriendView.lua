...
-- i18n pos lable
function HomelandFriendView:_adjustPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local size1 = self._playerName:getContentSize()
		local size2 = self._playerTxt:getContentSize()
		self._playerName:setAnchorPoint(cc.p(0.5,0.5))
		self._playerTxt:setAnchorPoint(cc.p(0.5,0.5))
		self._playerName:setPositionX(-size2.width*0.5)
		self._playerTxt:setPositionX(size1.width*0.5)
	end
end
