...
function HorseKarmaCell:_dealPosByI18n()
	...
	if Lang.checkUI("ui4") then
		for i = 1, 3 do
			self["_textTitle"..i]:setFontSize(20)	 
			-- 属性
			ccui.Helper:seekNodeByName(self["_fileNodeTitle"..i], "TextAttr_4"):setPosition(cc.p(55, 200))
			for t = 1, 4 do
				local str = "TextAttr_" .. t
				ccui.Helper:seekNodeByName(self["_fileNodeTitle"..i], str):setFontSize(16)
			end
			-- 线条
			ccui.Helper:seekNodeByName(self["_fileNodeTitle"..i], "Image_7"):loadTexture(Path.getUICommon("img_com_line01_board"))
			ccui.Helper:seekNodeByName(self["_fileNodeTitle"..i], "Image_7"):setContentSize(cc.size(200, 5))
			ccui.Helper:seekNodeByName(self["_fileNodeTitle"..i], "Image_7"):setPosition(cc.p(150, 184))
			-- Icon
			for n = 1, 2 do
				self["_fileNodeIcon" .. i .. "_" .. n]:setPositionY(122)
				self["_fileNodeIcon" .. i .. "_" .. n]:setScale(0.85)
			end
		end
	end
end
