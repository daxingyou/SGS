...
-- i18n change lable
function PopupTowerSuperStage:_swapImageByI18n()
...
-- i18n
function PopupTowerSuperStage:_dealByI18n()
    if Lang.checkLang(Lang.JA) then
        local text = ccui.Helper:seekNodeByName(self, "Text_20")
        text:setFontSize(16)

        local text = ccui.Helper:seekNodeByName(self, "Text_21")
        text:setFontSize(16)
    end
end
