...
function HistoryHeroDetailWeaponModule:onCreate()
    ...
    if Lang.checkUI("ui4") then -- i18n ja 
        ...
        ccui.Helper:seekNodeByName(self._nodeTitle, "ImageBase"):setContentSize(cc.size(396, 37))
...
function HistoryHeroDetailWeaponModule:_updateDesc(configId)
    ...
    if self._nodeTitle2 then -- i18n ja change
        self._nodeTitle2:setPositionY(self._nodeTitle2:getPositionY()+offset+2)
    end
