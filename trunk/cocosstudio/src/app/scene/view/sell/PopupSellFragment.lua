...
-- i18n ja change pos
function PopupSellFragment:_dealPosI18n(trueOrFalse)
    if Lang.checkLang(Lang.JA)  then
        self._selectNum:setPositionX(self._selectNum:getPositionX() + 35)
        self._totalGet:setPositionX(self._totalGet:getPositionX() + 16)
        self._totalGet1:setPositionX(self._totalGet1:getPositionX() + 40)
	end
end
