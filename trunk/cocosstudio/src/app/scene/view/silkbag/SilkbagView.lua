...
-- i18n ja change size
function SilkbagView:_initInfo()
...
-- i18n change lable
function SilkbagView:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
        local UIHelper  = require("yoka.utils.UIHelper")
        local image21 = UIHelper.seekNodeByName(self._nodeHero,"Image_21")
        UIHelper.swapWithLabel(image21,{
