...
-- i18n pos 
function ComponentCampPlayers:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")	
		self._imageLeft:setPositionX(self._imageLeft:getPositionX()-30)
		self._imageRight:setPositionX(self._imageRight:getPositionX()+30)
	end
end
