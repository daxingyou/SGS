...
-- i18n change lable
function SiegeChallengeBtns:_createLabelByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
        local image = UIHelper.seekNodeByName(self,"ImagePowerBG")
		UIHelper.swapSignImage(image,
		{ 
			 style = "sign_3", 
			 text = Lang.getImgText("img_hurt") ,
			 anchorPoint = cc.p(0.5,0.5),
			 rotation = -30,
		},Path.getTextSign("img_hurt"))
	end
end
