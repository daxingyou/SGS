...
-- i18n pos lable
function GuildWarRebornCDNode:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
        local UIHelper  = require("yoka.utils.UIHelper")
        self._textTime:setAnchorPoint(cc.p(0.5,0.5))
        UIHelper.alignCenter(self._panelShadow,{self._text1,self._textTime,self._text2})
	end
end
