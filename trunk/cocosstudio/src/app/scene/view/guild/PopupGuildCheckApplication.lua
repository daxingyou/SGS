...
-- i18n pos lable
function PopupGuildCheckApplication:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local image1 = UIHelper.seekNodeByName(self._imageRoot,"Image_13_2_0")
		local image2 = UIHelper.seekNodeByName(self._imageRoot,"Image_13_2_0_0")
		image1:setPositionX(image1:getPositionX()-6)
        image2:setPositionX(image2:getPositionX()+6)
