...
--	self._topbarBase:setBGType(2)--使用长文字底图
	...
	if Lang.checkLang(Lang.JA) then
		local img = ccui.Helper:seekNodeByName(self, "Image_281")
		img:setPositionX(100)
		self._textGuidLevel:setPositionX(78)
	end
	if  Lang.checkUI("ui4") then   
		local imageGuidInfo = ccui.Helper:seekNodeByName(self, "ImageGuidInfo")
		-- 左偏移26
		imageGuidInfo:setPositionX(0)
	end
