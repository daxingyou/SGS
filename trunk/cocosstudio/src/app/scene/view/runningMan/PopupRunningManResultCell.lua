...
function PopupRunningManResultCell:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")	
		self._commonIcon:setPositionX(self._commonIcon:getPositionX()-70)
		self._textPlayerName:setPositionX(self._textPlayerName:getPositionX()-70)
	end
end
