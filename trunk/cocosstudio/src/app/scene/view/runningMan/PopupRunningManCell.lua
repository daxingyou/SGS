...
function PopupRunningManCell:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")	
		self._imageTake = UIHelper.swapSignImage(self._imageTake,
		{ 
			 style = "signet_3", 
		...
		if Lang.checkLang(Lang.JA) then
			self._imagePriceBk:setCascadeOpacityEnabled(false)
			self._imagePriceBk:setOpacity(0)
		end
	end
end
