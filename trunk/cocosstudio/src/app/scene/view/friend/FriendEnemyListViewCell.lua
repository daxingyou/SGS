...
-- i18n pos lable
function FriendEnemyListViewCell:_dealPosI18n()
	if not Lang.checkLang(Lang.CN)  then
		local UIHelper  = require("yoka.utils.UIHelper")
        self._powerNum:setPositionX( self._powerNum:getPositionX() - 60 + 3 )
		self._guildName:setPositionX( self._guildName:getPositionX() - 68 )
		self._mineName:setPositionX( self._mineName:getPositionX() - 30 - 3 )
