...
function PopupHomelandMainUp:_dealPosByI18n()
	...
	if Lang.checkLang(Lang.JA) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local text114 = UIHelper.seekNodeByName(self,"Node_attr_desc1","Text_11_4")
		local img14 = UIHelper.seekNodeByName(self,"Node_attr_desc1","Image_14")
		text114:setPositionX(text114:getPositionX()+15)
		img14:setPositionX(img14:getPositionX()+20)
	end
end
