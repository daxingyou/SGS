...
function PopupHomelandSubUp:_dealPosI18n()
	...
	if Lang.checkUI("ui4") then 
		local node_attr_desc1 = ccui.Helper:seekNodeByName(self._nodeSubTree, "Node_attr_desc1")
		ccui.Helper:seekNodeByName(node_attr_desc1, "Text_11_4"):setFontSize(18)
		ccui.Helper:seekNodeByName(node_attr_desc1, "Text_11_4_0"):setFontSize(18)
	end
	if Lang.checkLang(Lang.JA) then
		self["_resSubItem1"]:setPositionX(615)
		self["_resSubItem2"]:setPositionX(799)
	end
end
