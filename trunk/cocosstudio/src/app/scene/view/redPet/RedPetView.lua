...
function RedPetView:_dealByI18n()
    if Lang.checkLang(Lang.JA) then
        local UIHelper  = require("yoka.utils.UIHelper")
        local text6 = UIHelper.seekNodeByName(self._awardBg,"Text_6")
        text6:setVisible(false)
        self._refreshCost:setAnchorPoint(0,0.5)
        self._refreshCost:setPositionX(70)
        self._refreshCost:setFontSize(18)
        local text60 = UIHelper.seekNodeByName(self._awardBg,"Text_6_0")
        text60:setPositionX(self._refreshCost:getPositionX()+self._refreshCost:getContentSize().width)
        text60:setFontSize(18)
    end
end
