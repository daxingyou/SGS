...
-- i18n change lable
function RedPetAvatarNode:_dealI18n()
	if Lang.checkLang(Lang.VN) then
		self._nameBg:setRotation(-90)
        self._avatarName:ignoreContentAdaptWithSize(true)
        self._nameEffectNode:setRotation(-90)
        self._nameBg:setPositionY(self._nameBg:getPositionY() + 50)
        self._avatarName:setPositionY(self._avatarName:getPositionY() + 35)
        self._nameEffectNode:setPositionY(self._nameEffectNode:getPositionY() + 35)
    end
end
