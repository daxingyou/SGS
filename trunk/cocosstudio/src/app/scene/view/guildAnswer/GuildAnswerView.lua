...
function GuildAnswerView:_initRankTab()
	...
	if Lang.checkLang(Lang.JA) then
		for i = 1, 2 do
			local item = self._nodeTabRoot:getTabItem(i)
			item.textWidget:setFontSize(16)
		end
	end
end
...
function GuildAnswerView:_updateRankRewardInfo()
	...
	if Lang.checkUI("ui4") then
		self._rankRewardListViewItem:setListViewSize(380-35,100)
		local posX = -460 + 25
...
-- i18n change lable
function GuildAnswerView:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local image1 = UIHelper.seekNodeByName(self,"AwardImage")
...
-- i18n change lable
function GuildAnswerView:_dealByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		self._chatMini:setLocalZOrder(1)
	end	
	if Lang.checkLang(Lang.JA) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local titleCount = UIHelper.seekNodeByName(self._rankTopGuild,"titleCount")
		local titleName = UIHelper.seekNodeByName(self._rankTopGuild,"titleName")
		local titleChapter = UIHelper.seekNodeByName(self._rankTopGuild,"titleChapter")
		titleCount:setFontSize(20)
		titleName:setFontSize(20)
		titleChapter:setFontSize(20)
		local titleCount = UIHelper.seekNodeByName(self._rankTopPerson,"titleCount")
		local titleName = UIHelper.seekNodeByName(self._rankTopPerson,"titleName")
		local titleChapter = UIHelper.seekNodeByName(self._rankTopPerson,"titleChapter")
		titleCount:setFontSize(20)
		titleName:setFontSize(20)
		titleChapter:setFontSize(20)
		local line1 = UIHelper.seekNodeByName(self._rankTopPerson,"line1")
		line1:setPositionX(75)
		local line2 = UIHelper.seekNodeByName(self._rankTopPerson,"line2")
		line2:setPositionX(215)
		titleChapter:setPositionX(260)
	end
end

function GuildAnswerView:_awardPosByI18n()
	if Lang.checkUI("ui4") then
		local UIHelper  = require("yoka.utils.UIHelper")
        local bg = UIHelper.createImage({texture = Path.getWorldBossUI("img_worldboss_title022") })
		bg:setPosition(-452,-162)
		local panel = UIHelper.seekNodeByName(self,"Panel_1")
		panel:addChild(bg)
		local image3 = UIHelper.seekNodeByName(self,"AwardImage")
		image3:setPosition(-452,-162)
		image3:getVirtualRenderer():setWidth(20)
		image3:setFontSize(20)
		image3:setColor(cc.c3b(0xfe,0xe1,0x02))
		image3:setLocalZOrder(1)

		local text45 = UIHelper.seekNodeByName(self,"Text_45")
		text45:setAnchorPoint(0.5,0.5)
		text45:setFontSize(16)
		text45:setColor(cc.c3b(0xff,0xb8,0x0c))
		text45:setPosition(-319,-114)
