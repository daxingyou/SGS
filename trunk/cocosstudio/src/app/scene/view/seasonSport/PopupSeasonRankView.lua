...
-- i18n pos lable
function PopupSeasonRankView:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
        local text64 = UIHelper.seekNodeByName(self,"Panel_ownInfo","Text_64") 
		local size = text64:getContentSize()
		self._ownRank:setPositionX(size.width+ 2)
		if Lang.checkLang(Lang.VN) then
			self._ownRank:setPositionY(size.height * 0.5-3)
		end
	end
end
