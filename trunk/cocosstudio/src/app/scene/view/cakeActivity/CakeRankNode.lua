...
function CakeRankNode:_swapImageByI18n()
	...
	if Lang.checkLang(Lang.JA) then
		self._imageGuildTip:setPositionY(60)
	end
end
...
function CakeRankNode:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		...
		if Lang.checkLang(Lang.JA) then
			local text = UIHelper.seekNodeByName(self._target,"NodePlayer","ImageBgPlayer","Text_21_1")
			text:setPositionX(5)
			local textGuild = UIHelper.seekNodeByName(self._target,"NodeGuild","ImageBgGuild","Text_21")
			textGuild:setPositionX(5)
			textGuild:setAnchorPoint(cc.p(0,0.5))
			self._textLevelTitle:setAnchorPoint(1,0.5)
			self._textLevelTitle:setPositionX(self._textGuildScore:getPositionX()-3)
		end
	end
end
