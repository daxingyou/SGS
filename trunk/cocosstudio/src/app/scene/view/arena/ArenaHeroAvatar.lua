...
-- i18n change lable
function ArenaHeroAvatar:_dealI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		
        self._textPowerValue:setPositionX(self._textPowerValue:getPositionX() - 13)
        self._textUserName:setFontSize(self._textUserName:getFontSize()-2)
	...
	if Lang.checkUI("ui4") then
        self._imageSelf:getChildByName("Text_self"):setFontName(Path.getCommonFont())
        self._imageSelf:getChildByName("Text_self"):setFontSize(self._imageSelf:getChildByName("Text_self"):getFontSize() - 16)
        self._imageSelf:getChildByName("Text_self"):setString(Lang.get("txt_arena_self"))
        self._textPowerValue:setPositionX(110)
        self._btnSweep:setScale(1)
        self._btnSweep:getChildByName("Image_battle"):setScale(1)
        local text = self._btnSweep:getChildByName("Text")
        text:setFontSize(18)
