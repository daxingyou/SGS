...
function DrawEffectBase:onCreate()
    if not Lang.checkLang(Lang.CN) then
        local UIHelper  = require("yoka.utils.UIHelper")	
        local imageGet = UIHelper.seekNodeByName(self._imageGetBG,"Image_get")
        imageGet:ignoreContentAdaptWithSize(true)
        imageGet:setPositionY(imageGet:getPositionY()-8)
    end
