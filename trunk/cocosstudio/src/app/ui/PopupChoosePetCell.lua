...
-- i18n ja pos lable
function PopupChoosePetCell:_dealPosByI18n()
    if Lang.checkLang(Lang.JA) then  
        self._nodeStar1:setPositionX(self._nodeStar1:getPositionX()+20)
        self._nodeStar2:setPositionX(self._nodeStar2:getPositionX()+20)
    end
end
