		...
		if data then
			...
			if data.isYoke then
				...
				if Lang.checkLang(Lang.JA) then
					self["_textYoke" .. index]:setPosition(124 + width, 88)
				else
...
-- i18n pos lable
function PopupChooseEquipCell:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local textName1 = UIHelper.seekNodeByName(self._item1,"TextName")
		local textName2 = UIHelper.seekNodeByName(self._item2,"TextName")

		textName1:setFontSize(textName1:getFontSize()-2)
		textName2:setFontSize(textName2:getFontSize()-2)


		self._textYoke1:setFontSize(self._textYoke1:getFontSize()-2)
		self._textYoke2:setFontSize(self._textYoke2:getFontSize()-2)

		self._textHeroName1:setFontSize(self._textHeroName1:getFontSize()-2)
		self._textHeroName1:setAnchorPoint(cc.p(1,0))
		self._textHeroName1:setPositionX(self._textHeroName1:getPositionX()+70)
		
		self._textHeroName2:setFontSize(self._textHeroName2:getFontSize()-2)
		self._textHeroName2:setAnchorPoint(cc.p(1,0))
		self._textHeroName2:setPositionX(self._textHeroName2:getPositionX()+70)
	end
end
