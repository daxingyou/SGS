...
local EXPORTED_METHODS = {
    "updateUI",
    "showPanelBlue",
    "getImageResIcon", --i18n ja
    "getButtonAdd"  --i18n ja
}
...
function CommonTopBarItem:_init()
    ...
    if not Lang.checkLang(Lang.CN) then
        local size = self._labelNumber:getContentSize()
        self._labelNumber:setContentSize(cc.size(size.width+90,size.height))
    end
...
--i18n ja
function CommonTopBarItem:getImageResIcon()
    return self._imageResIcon
end

--i18n ja
function CommonTopBarItem:getButtonAdd()
    return self._buttonAdd
end
