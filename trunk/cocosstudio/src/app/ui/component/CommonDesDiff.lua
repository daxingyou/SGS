...
--ui4 自适应位置，在updateUI后调用
function CommonDesDiff:adaptivePos()
	self._textValue2:setPositionX(self._textValue1:getPositionX() + self._textValue1:getContentSize().width)
end
