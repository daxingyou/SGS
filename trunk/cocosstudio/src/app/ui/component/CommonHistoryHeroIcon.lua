...
-- i18n change lable
function CommonHistoryHeroIcon:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) and self._iconAwakenSquare then
        local UIHelper  = require("yoka.utils.UIHelper")
        self._iconAwakenSquare = UIHelper.swapWithLabel(self._iconAwakenSquare,{
           style = "historical_hero_1",
			text = Lang.getImgText("img_historical_debris"),
			offsetX = -7,
        })     
	end
end
