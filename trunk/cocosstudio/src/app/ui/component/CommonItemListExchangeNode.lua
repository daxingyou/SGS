...
local EXPORTED_METHODS = {
    "updateInfo",
    "setGaps", 
    "setCountFontSize",  -- i18n ja change font size
}
...
function CommonItemListExchangeNode:setCountFontSize(fontSize)
    for k1,v1 in ipairs(self._commonIconTemplateList) do 
        for k,node in ipairs(v1) do
          local iconTemplate = node:getIconTemplate()
          if iconTemplate and iconTemplate.setTextItemCountFontSize then 
            iconTemplate:setTextItemCountFontSize(fontSize) 
          end
        end
    end
end
