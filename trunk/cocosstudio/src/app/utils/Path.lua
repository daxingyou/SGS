...
-- i18n ja mouth
function Path.getStorySpinePointAsset(id)
	return "storyspine/" ..id
end
...
function Path.getLoadUI(id)
    return "ui3/load/"..id..png_suffix
end
-- i18n ja add
function Path.getPosterGirlVoice(id)
	return "audio/vip_voice/"..id..mp3_suffix
end

-- i18n ja add
function Path.getMonthlyCardRes2(id)
	return "ui3/topups/"..id..png_suffix
end
...
-- i18n ui4 add
function Path.getShowHeroUI4(id)
    return "ui3/showhero_ui4/"..id..png_suffix
end

-- i18n ui4 add
function Path.getSkinSpine(id)
	return "skinspine/" ..id.."_big"
end
-- i18n ja mouth
function Path.getSkinSpinePointAsset(id)
	return "skinspine/" ..id
end
