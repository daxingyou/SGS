...
addFunctions(import(".data.PosterGirlDataHelper"))--i18n ja
addFunctions(import(".data.NewLevelPkgDataHelper"))--i18n ja
...
function UserDataHelper.appendNodeTitle(node, titleId, moduleName)
	...
	-- i18n ja 人物头顶称号位置微调
	if Lang.checkLang(Lang.JA) and moduleName == "MineCraftView" then
		pos.y = pos.y - 15
	end
