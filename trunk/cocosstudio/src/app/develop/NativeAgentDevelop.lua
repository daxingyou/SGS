...
function NativeAgentDevelop:logout()
	...
	self:_dispatch({event = NativeConst.SDKLogoutResult, ret=NativeConst.STATUS_SUCCESS, param=""})
end
...
function NativeAgent:pay(appid, price, productId, productName, productDesc)
	...
	--i18n change
  	...
  	local value = "channelID=#channelID#&cp_order_id=#cp_order_id#&currency=RMB&extension=#extension#&gameID=#gameID#&money=#money#&orderID=#orderID#&orderTime=#orderTime#&platformID=#platformID#&productID=#productID#&serverID=#serverID#&userName=#userName#"
    ...
    url = string.gsub(url, "#cp_order_id#", "1")
    ...
    value = string.gsub(value, "#cp_order_id#", "1")
