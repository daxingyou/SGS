local SignalConst =
{
    ...
    EVENT_SDK_BINDGUEST             = "SDK_BINDGUEST",                  -- sdk游客绑定 -i8n 
    ...
    EVENT_ON_ENTER_GAME             = "EVENT_ON_ENTER_GAME",            -- 用户同意利用规约 开始进入游戏
    ...
    EVENT_WELFARE_FRIEND_INVITE_INFO = "event_welfare_friend_invite_info", --i18n ja 获取好友邀请信息
    EVENT_WELFARE_WRITE_INVITE = "event_welfare_write_invite",      --i18n ja 玩家填写邀请码 WriteInvite
    EVENT_WELFARE_INVITE_REWARD = "event_welfare_invite_reward",    --i18n ja 请求奖励 InviteReward
 ...
 -- 无差别竞技
	...
	--i18n late regist 后加入玩家补偿
	EVENT_ACT_LATE_REGIST_AWARD_SUCCESS = "event_act_late_regist_award_success",
    EVENT_ACT_LATE_REGIST_TASK_INFO = "event_act_late_regist_task_info",
    --i18n
    EVENT_TRANSLATE_SUCCESS = "EVENT_TRANSLATE_SUCCESS",--翻译成功


    -- i18n ja audio patch 显示语音分包下载按钮
    EVENT_SHOW_AUDIO_PATCH = "EVENT_SHOW_AUDIO_PATCH",
    -- i18n ja 刷新主界面看板娘和场景
    EVENT_SWITCH_AVATAR = "EVENT_SWITCH_AVATAR",
    EVENT_SWITCH_SCENE = "EVENT_SWITCH_SCENE",
	
    -- i18n ja 购买主场景
    EVENT_BUY_MAIN_SCENE = "EVENT_BUY_MAIN_SCENE",
    -- i18n ja 主界面看板娘说话
    EVENT_MAIN_AVATAR_TALK = "EVENT_MAIN_AVATAR_TALK",

    
    -- i18n ja 看板娘播放语音
    EVENT_POSTER_GIRL_PLAY_VOICE = "EVENT_POSTER_GIRL_PLAY_VOICE",
    -- i18n ja 看板娘语音
    EVENT_POSTER_GIRL_VOICE_UPDATE = "EVENT_POSTER_GIRL_VOICE_UPDATE",
    -- i18n ja 看板娘语音清除
    EVENT_POSTER_GIRL_VOICE_CLEAR = "EVENT_POSTER_GIRL_VOICE_CLEAR",
    -- i18n ja 看板娘换装
    EVENT_POSTER_GIRL_CHANGE_SKIN_SUCCESS = "EVENT_POSTER_GIRL_CHANGE_SKIN_SUCCESS",
    -- i18n ja 看板娘皮肤增删改
    EVENT_POSTER_GIRL_SKIN_UPDATE = "EVENT_POSTER_GIRL_SKIN_UPDATE",
    -- i18n ja 看板娘皮肤信息GET
    EVENT_POSTER_GIRL_SKIN_INFO_GET = "EVENT_POSTER_GIRL_SKIN_INFO_GET",
    -- i18n ja 看板娘宝箱信息更新
    EVENT_POSTER_GIRL_BOX_INFO_UPDATE = "EVENT_POSTER_GIRL_BOX_INFO_UPDATE",
    -- i18n ja 看板娘宝箱领取成功
    EVENT_POSTER_GIRL_BOX_RECEIVE_SUCCESS = "EVENT_POSTER_GIRL_BOX_RECEIVE_SUCCESS",
    -- i18n ja vip升级
    EVENT_VIP_UPGRADE = "event_vip_upgrade",--VIP 升级
    -- i18n ja 播加vip特效
    EVENT_VIP_ADD_EXP_BALL = "event_vip_add_exp_ball",--VIP 升级加经验球
    -- i18n ja vip tab 跳转事件
    EVENT_VIP_GO_TO_TAB = "EVENT_VIP_GO_TO_TAB",
    -- i18n ja exp over经验溢出
    EVENT_GET_EXP_OVER_AWARD = "EVENT_GET_EXP_OVER_AWARD",
    -- i18n ja 绑定成功
    EVENT_BIND_SUCCESS = "EVENT_BIND_SUCCESS",

    -- i18n ja 打开等级礼包UI通知
    EVENT_NEW_LEVEL_PKG_OPEN_NOTICE = "EVENT_NEW_LEVEL_PKG_OPEN_NOTICE",

    -- i18n ja 公告红点
    EVENT_NOTICE_RED_POINT = "EVENT_NOTICE_RED_POINT",

    -- i18n ja 举报成功
    EVENT_CHAT_TIPOFF_SUCCESS = "EVENT_CHAT_TIPOFF_SUCCESS",
    -- i18n ja 周分享
    EVENT_WEEK_SHARE_REWARD = "EVENT_WEEK_SHARE_REWARD",
    -- i18n ja 看板娘
    EVENT_GET_HERO_RES_PHOTO_SUCCESS = "EVENT_GET_HERO_RES_PHOTO_SUCCESS",
    -- i18n 截图
    EVENT_CAPTURED_RESULT_NOTICE = "EVENT_CAPTURED_RESULT_NOTICE",
    -- 名将绘卷
    EVENT_GET_TEAM_INFO_SUCCESS = "EVENT_GET_TEAM_INFO_SUCCESS",
    EVENT_ACTIVE_HERO_SUCCESS = "EVENT_ACTIVE_HERO_SUCCESS",
    EVENT_LEVELUP_HERO_SUCCESS = "EVENT_LEVELUP_HERO_SUCCESS",
}
return SignalConst
