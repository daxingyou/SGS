...
function CommonTreasureProperty:_init()
	...
	if Lang.checkChannel(Lang.CHANNEL_SEA) then
		self._name2:ignoreContentAdaptWithSize(true)
		self._name2:setPositionY(self._name2:getPositionY()-5)
	end
end
...
function CommonTreasureProperty:setName(treasureBaseId,rLevel)
	...
	-- self._name2:enableOutline(treasureParam.icon_color_outline, 2)
end
