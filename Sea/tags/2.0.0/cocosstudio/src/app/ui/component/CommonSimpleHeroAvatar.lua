...
--获取SpineId
function CommonSimpleHeroAvatar:_getSpineData(heroId,animSuffix,limitLevel)
	local TypeConvertHelper = require("app.utils.TypeConvertHelper")
...
function CommonSimpleHeroAvatar:updateUI(heroId, animSuffix, notPlayIdle, limitLevel)
...
function CommonSimpleHeroAvatar:_initSpine(heroId,animSuffix,limitLevel)
	self._heroId = heroId
