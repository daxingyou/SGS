...
function CommonPetProperty:buildSkillModule()
	...
	local skillIds = {}
	local petStarConfig = UserDataHelper.getPetStarConfig(petUnitData:getBase_id(), 0)
	for i = 1, 2 do
	...
	if #skillIds > 0 then
		self._skillModule = PetDetailSkillModule.new(skillIds,false,petUnitData:getBase_id(), 0)
