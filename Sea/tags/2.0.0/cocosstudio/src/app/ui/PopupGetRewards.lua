...
function PopupGetRewards:_updateAwards(rewardParentNodes, awards)
...
function PopupGetRewards:_updateAwardsNew(rewardParentNodes, awards,itemTextLineWidth)
    LINE_ITEM_BLACK =  55
    LINE_ITEM_BLACK_V = 3
    local itemScale = 1 ---缩放80%
    local itemWidgets = {}
...
---@finishCallback 结束回调
---==========================
function PopupGetRewards:show(awards,fromText,tipsText,finishCallback, titleImagePath)
    ...
    if not Lang.checkLang(Lang.CN)  then
        itemWidgets = self:_updateAwardsNew(rewardsNode, awards)
    else
