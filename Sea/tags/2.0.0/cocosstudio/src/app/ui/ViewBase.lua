...
function ViewBase:updateSceneId(sceneId)
     if sceneId then
        ...
        if sceneId == 9999 then
            self._sceneData = {
                id = 9999,    
                background = "ui3/stage/img_chuangjue_chengqiang.png",    
                farground = "ui3/stage/img_chuangjue_yuanjing.jpg",    
                front_eft = "",    
                middle_eft = "xinchuangjue_middle",    
                back_eft = "xinchuangjue_back",    
                is_turn =0,   
            }
        else
