...
function PopupComposeFragment:onCreate()
	...
	self._nodeBg:addCloseEventListener( function () self:closeWithAction() end ) --i8
end
...
function PopupComposeFragment:_updateView()
	...
	if not Lang.checkLang(Lang.CN) then
		self._fileNodeFrag:setPositionX(self._textName:getPositionX()+self._textName:getContentSize().width + 10)
	end
	local attrInfo = {}
