...
function PopupUserBaseInfo:updateUI(simpleUser)
	...
	-- if simpleUser.avatarBaseId > 0 then
	-- 	local AvatarDataHelper = require("app.utils.data.AvatarDataHelper")
	-- 	local info = AvatarDataHelper.getAvatarConfig(simpleUser.avatarBaseId)
	-- 	baseId = info.hero_id
	-- 	if info.limit == 1 then
	-- 		limitLevel = require("app.const.HeroConst").HERO_LIMIT_MAX_LEVEL
	-- 	end
	-- else
	-- 	baseId = simpleUser.baseId
	-- end
