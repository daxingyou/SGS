...
--i18n
function PopupChooseHorseCell:_dealByI18n()
	self._textTip1:getVirtualRenderer():setLineSpacing(6)
	self._textTip2:getVirtualRenderer():setLineSpacing(6)
	self._textTip1:setFontSize(18)
	self._textTip2:setFontSize(18)
end
