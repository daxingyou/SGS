...
function PopupPlayerLevelUp:_dealByI18n(wayItem)
	if Lang.checkChannel(Lang.CHANNEL_SEA) then
		...
		imgFrame:setPositionX(imgFrame:getPositionX()-20)
		textDesc:setPositionX(textDesc:getPositionX()-20)
		textName:setPositionX(textName:getPositionX()-20)
