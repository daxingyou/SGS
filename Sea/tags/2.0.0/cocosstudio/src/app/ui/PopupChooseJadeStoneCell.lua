...
function PopupChooseJadeStoneCell:_showAttrDes(index, data)
	...
	if Lang.checkLang(Lang.CN) then
		...
		self["_nodeAttr" .. index .. "_" .. 1]:setValueToRichText(desInfo, 190)
	end
...
function PopupChooseJadeStoneCell:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		...
		for index = 1, 2 do
			self["_nodeAttr" .. index .. "_" .. 1]:setPositionX(self["_nodeAttr" .. index .. "_" .. 1]:getPositionX()-10)
			self["_nodeAttr" .. index .. "_" .. 2]:setPositionX(self["_nodeAttr" .. index .. "_" .. 2]:getPositionX()-10)
		end
	...
	if Lang.checkLang(Lang.EN) then
		for index = 1, 2 do
			self["_nodeAttr" .. index .. "_" .. 1]:setPositionY(self["_nodeAttr" .. index .. "_" .. 1]:getPositionY()+23)
			self["_nodeAttr" .. index .. "_" .. 2]:setPositionY(self["_nodeAttr" .. index .. "_" .. 2]:getPositionY()+23)
		end
	end
end
