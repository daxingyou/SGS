...
-- i18n change lable
function PopupSelectRewardTab:_updatePosByI18n()
	if not Lang.checkLang(Lang.CN)  then
		local UIHelper  = require("yoka.utils.UIHelper")
		logWarn("PopupSelectRewardTab------------- xx")
		local image1 = UIHelper.seekNodeByName(self._commonNodeBk,"Node_select_bg","Image_18")
		UIHelper.alignCenter(self._commonNodeBk,{image1,self._textChoose})
	end
end
