...
local HistoryHeroTrainBreakLayer = require("app.scene.view.historyhero.HistoryHeroTrainBreakLayer")
...
function HistoryHeroDetaillLayer:_initBaseView()
	self["_historyDetail1"] = HistoryHeroAttrLayer.new()
	self["_historyDetail2"] = HistoryHeroTrainAwakeLayer.new()
	self["_historyDetail3"] = HistoryHeroTrainBreakLayer.new()
	self._nodeLayer:addChild(self["_historyDetail1"])
	self._nodeLayer:addChild(self["_historyDetail2"])
	self._nodeLayer:addChild(self["_historyDetail3"])
...
-- i18n change lable
function HistoryHeroDetaillLayer:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
