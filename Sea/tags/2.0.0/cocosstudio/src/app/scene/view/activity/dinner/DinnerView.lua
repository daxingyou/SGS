...
-- i18n change lable
function DinnerView:_dealI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		if Lang.checkLang(Lang.ZH) then
			self._textDinnerName01:setPositionX( self._textDinnerName01:getPositionX()+2)
			self._textDinnerName02:setPositionX( self._textDinnerName02:getPositionX()+2)
			self._textDinnerName03:setPositionX( self._textDinnerName03:getPositionX()+2)
			self._textDinnerTime01:setPositionX( self._textDinnerTime01:getPositionX() - 14 )
			self._textDinnerTime02:setPositionX( self._textDinnerTime02:getPositionX() - 14 )
			self._textDinnerTime03:setPositionX( self._textDinnerTime03:getPositionX() - 14 )
		elseif Lang.checkLang(Lang.EN) then
			self._textDinnerName01:setPositionX( self._textDinnerName01:getPositionX() - 6)
			self._textDinnerName02:setPositionX( self._textDinnerName02:getPositionX() - 6)
			self._textDinnerName03:setPositionX( self._textDinnerName03:getPositionX() - 6)
			self._textDinnerTime01:setPositionX( self._textDinnerTime01:getPositionX() -6 )
			self._textDinnerTime02:setPositionX( self._textDinnerTime02:getPositionX() -6 )
			self._textDinnerTime03:setPositionX( self._textDinnerTime03:getPositionX() -6 )
		elseif Lang.checkLang(Lang.TH) then
			self._textDinnerName01:setPositionX( self._textDinnerName01:getPositionX() - 8)
			self._textDinnerName02:setPositionX( self._textDinnerName02:getPositionX() - 8)
			self._textDinnerName03:setPositionX( self._textDinnerName03:getPositionX() - 8)
			self._textDinnerTime01:setPositionX( self._textDinnerTime01:getPositionX() - 4 )
			self._textDinnerTime02:setPositionX( self._textDinnerTime02:getPositionX() - 4 )
			self._textDinnerTime03:setPositionX( self._textDinnerTime03:getPositionX() - 4 )
		else
			self._textDinnerName01:setPositionX( self._textDinnerName01:getPositionX() - 5)
			self._textDinnerName02:setPositionX( self._textDinnerName02:getPositionX() - 5)
			self._textDinnerName03:setPositionX( self._textDinnerName03:getPositionX() - 5)
			self._textDinnerTime01:setPositionX( self._textDinnerTime01:getPositionX() + 5 )
			self._textDinnerTime02:setPositionX( self._textDinnerTime02:getPositionX() + 5 )
			self._textDinnerTime03:setPositionX( self._textDinnerTime03:getPositionX() + 5 )
		end
      

		local label = UIHelper.seekNodeByName(self,"Panel_left_bg","Tip_BG","Text_2")
		label:setPositionX(label:getPositionX()-18)

		if Lang.checkLang(Lang.TH) then
			label:setAnchorPoint(1,0.5)
			label:setPositionX(185)
			local titleLabel = UIHelper.seekNodeByName(self,"Panel_left_bg","Image_3","TitleLabel")
			titleLabel:setFontSize(titleLabel:getFontSize()+1)
			self._textCDTitle:setFontSize(self._textCDTitle:getFontSize()+1)
			self._textCD:setFontSize(self._textCD:getFontSize()+1)
			self._textCDHint:setFontSize(self._textCDHint:getFontSize()+1)
		end
		if Lang.checkLang(Lang.ENID) then
			local tipbg = UIHelper.seekNodeByName(self,"Panel_left_bg","Tip_BG")
			local label = UIHelper.seekNodeByName(self,"Panel_left_bg","Tip_BG","Text_2")
			label:setAnchorPoint(0,0.5)
			label:setTextHorizontalAlignment(cc.TEXT_ALIGNMENT_CENTER )
			-- label:setPositionX(label:getPositionX()-58)
			tipbg:setPositionX(tipbg:getPositionX()-20)
			tipbg:setPositionY(tipbg:getPositionY()+40)
