...
-- i18n pos lable
function PackageGemstoneCell:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")

        local image1 = UIHelper.seekNodeByName(self._gemstonePropInfo1,"Image_1")
		local size1 = image1:getContentSize()
        image1:setContentSize(
            size1.width+28,size1.height
        )
		image1:setPositionX(image1:getPositionX()+14)
		local image2 = UIHelper.seekNodeByName(self._gemstonePropInfo2,"Image_1_0")
		local size2 = image2:getContentSize()
		image2:setContentSize(
            size2.width+28,size2.height
        )
		image2:setPositionX(image2:getPositionX()+14)


		self._nodeAttr12:setPositionX(self._nodeAttr12:getPositionX()+14)
		self._nodeAttr14:setPositionX(self._nodeAttr14:getPositionX()+14)
		
		self._nodeAttr22:setPositionX(self._nodeAttr22:getPositionX()+14)
		self._nodeAttr24:setPositionX(self._nodeAttr24:getPositionX()+14)
	...
	if Lang.checkLang(Lang.TH) then
		...
		self._nodeAttr12:setPositionX(self._nodeAttr12:getPositionX()+20)
		self._nodeAttr14:setPositionX(self._nodeAttr14:getPositionX()+20)
		self._nodeAttr22:setPositionX(self._nodeAttr22:getPositionX()+20)
		self._nodeAttr24:setPositionX(self._nodeAttr24:getPositionX()+20)
	end
end
