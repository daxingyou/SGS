...
function EquipDetailSuitNode:_dealByI18n()
	...
	if Lang.checkLang(Lang.TH) then
		self["_textValue1_1"]:setPositionX(self["_textValue1_1"]:getPositionX()+10)
		self["_textValue2_1"]:setPositionX(self["_textValue2_1"]:getPositionX()+10)
		self["_textValue3_1"]:setPositionX(self["_textValue3_1"]:getPositionX()+10)
		self["_textValue3_2"]:setPositionX(self["_textValue3_2"]:getPositionX()+10)
	end
end
