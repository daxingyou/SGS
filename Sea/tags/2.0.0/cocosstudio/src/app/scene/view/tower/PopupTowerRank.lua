...
function PopupTowerRank:_setMyInfo()
	...
	-- self._textMyName:enableOutline(Color.getColorOutline(color), 2)
...
--i18n
function PopupTowerRank:_dealByI18n()
    if Lang.checkChannel(Lang.CHANNEL_SEA) then
        local UIHelper  = require("yoka.utils.UIHelper")
        local textCount = UIHelper.seekNodeByName(self._titleBG,"titleStarCount")
        textCount:setPositionX(textCount:getPositionX()+9)
    end
end
