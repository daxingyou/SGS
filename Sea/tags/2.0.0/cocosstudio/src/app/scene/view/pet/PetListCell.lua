...
--i18n
function PetListCell:_dealByI18n()
	if Lang.checkLang(Lang.TH) then
		self._nodeStar1:setPositionX(self._nodeStar1:getPositionX()+30)
		self._nodeStar2:setPositionX(self._nodeStar2:getPositionX()+30)
	end
end
