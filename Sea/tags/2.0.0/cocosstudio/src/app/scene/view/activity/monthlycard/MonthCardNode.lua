...
function MonthCardNode:ctor(node,index,callBack)
	...
	cc.bind(self._commonButton1, "CommonButtonSwitchLevel0")
...
function MonthCardNode:_swapImageByI18n()
	...
	if Lang.checkChannel(Lang.CHANNEL_SEA)  then
		self._labelTotalGold:setPositionY(self._labelTotalGold:getPositionY()+3)
	end
end
...
function MonthCardNode:_updateDailyGetPosI18n()
	if Lang.checkChannel(Lang.CHANNEL_SEA)  then
		...
		local image1 = UIHelper.seekNodeByName(self._node,"Image_39")
		local text1 = UIHelper.seekNodeByName(image1,"Text_02")
		UIHelper.alignCenter(self._commonButton1,{text1,self._atlasLabel02,image1},
			{3,3,0},nil,{image1,text1,self._atlasLabel02})

		local image2 = UIHelper.seekNodeByName(self._node,"Image_send")
		UIHelper.alignCenter(self._commonButton1,{self._text03,self._atlasLabel03,image2},
		{10,10,0},nil,{image2,self._text03,self._atlasLabel03})
	end
...
function MonthCardNode:_updateTotalGetPosI18n()
	if Lang.checkChannel(Lang.CHANNEL_SEA)  then
		local UIHelper  = require("yoka.utils.UIHelper")
		UIHelper.alignCenter(self._commonButton1,{self._textDes,self._labelTotalGold},{10,0})
	end
