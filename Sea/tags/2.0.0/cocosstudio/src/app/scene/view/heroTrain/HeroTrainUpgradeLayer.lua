...
-- i18n pos lable
function HeroTrainUpgradeLayer:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local text = UIHelper.seekNodeByName(self._panelLeader,"Text_40")
		...
		self:_dealLevelOverlapPosByI18n()
	end
	if Lang.checkChannel(Lang.CHANNEL_SEA) then
		self._textOldLevel1:setPositionX(self._textOldLevel1:getPositionX()+5)
	end
end
-- i18n pos lable
function HeroTrainUpgradeLayer:_dealLevelOverlapPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
