...
function ResourceBackCell:_updateRichTip(parentNode, num)
	...
	if not Lang.checkLang(Lang.CN) then
		parentNode:setPositionX(450)
		richtext:setAnchorPoint(1, 0.5)
	else
		richtext:setAnchorPoint(0.5, 0.5)		
	end
...
--i18n
function ResourceBackCell:_dealByI18n()
	if Lang.checkLang(Lang.EN) or Lang.checkLang(Lang.TH) then
		self._richTipNode1:setPositionY(85)
		self._richTipNode2:setPositionY(85)
		self._btnBuy1:setPositionY(45)
		self._btnBuy2:setPositionY(45)
	end
end
