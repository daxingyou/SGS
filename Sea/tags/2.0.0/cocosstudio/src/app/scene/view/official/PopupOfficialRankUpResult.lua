	...
	if not Lang.checkLang(Lang.CN) then
		...
		for index = 1,5 do
			...
			if Lang.checkLang(Lang.TH)  then
				...
				local textName = attrNode:getSubNodeByName("TextName")
				local textName2 = attrNode:getSubNodeByName("TextName2")
				textName:setPositionX(textName:getPositionX() - 52)
				textName2:setPositionX(textName2:getPositionX() - 52)
			end
		end
