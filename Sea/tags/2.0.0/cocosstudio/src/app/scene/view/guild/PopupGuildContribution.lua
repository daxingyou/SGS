...
function PopupGuildContribution:onCreate()
	...
	if not Lang.checkLang(Lang.CN) then
		  self._panelBg:setTitle(Lang.getImgText("guild_contribution_title"))
	end
...
--i18n
function PopupGuildContribution:_dealByI18n()
	local text = ccui.Helper:seekNodeByName(self, "Text_6")
    if Lang.checkLang(Lang.EN) then
		text:setPositionX(text:getPositionX()-15)
