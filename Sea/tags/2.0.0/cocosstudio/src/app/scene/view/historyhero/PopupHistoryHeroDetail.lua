...
function PopupHistoryHeroDetail:ctor(type, uniqueId, value, isPage, limitLevel)
	self._type = type
...
function PopupHistoryHeroDetail:_updateHeroInfo(heroBaseId, limitLevel)
	...
	self._hasText:setVisible(false)
