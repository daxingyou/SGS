...
-- i18n pos 
function ActivityGuildSprintItemCell:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")	
		self._textGuildName:setAnchorPoint(cc.p(0.5,0.5))
		self._textGuildName:setPositionX(self._textGuildName:getPositionX()+57)
	end
end
