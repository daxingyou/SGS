...
function PopupDailyChooseCell:_dealI18n()
    ...
    if Lang.checkLang(Lang.ENID) then
        self._textDetail:setFontSize(18)
        self._textDetail:getVirtualRenderer():setMaxLineWidth(180)
    end
end
