...
function DailyMissionItemCell:_updateDailyNode(missionInfo)
	...
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")	
		self:getSubNodeByName("Node_reward"):setPositionX(171)	
	else
...
-- i18n change lable
function DailyMissionItemCell:_dealByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")	
		...
		-- local nodeReward = UIHelper.seekNodeByName(self,"Node_reward")
		-- local nodeDaily = UIHelper.seekNodeByName(self,"Node_daily")

		
		-- self._dailyActivityValue:setPositionX(self._dailyActivityValue:getPositionX() + 42)
		-- self._commonResInfo1:setPositionX(self._commonResInfo1:getPositionX() + 25)
		-- self._commonResInfo2:setPositionX(self._commonResInfo2:getPositionX() + 25)
	end
end

-- i18n pos lable
function DailyMissionItemCell:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
	...
	if  Lang.checkLang(Lang.KR) or Lang.checkLang(Lang.EN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local textResName0 = UIHelper.seekNodeByName(self,"Node_daily","Text_ResName_0")
		self._dailyActivityValue:setPositionX(textResName0:getPositionX() + textResName0:getContentSize().width+5)
