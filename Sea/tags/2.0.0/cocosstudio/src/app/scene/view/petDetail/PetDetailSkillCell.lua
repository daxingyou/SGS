...
function PetDetailSkillCell:ctor(skillId,showSkillDetail,petBaseId, petStar)
...
function PetDetailSkillCell:_onButtonSkill( ... )
	...
	local skillShowList = require("app.scene.view.petDetail.PetDetailViewHelper").makeSkillEx(petId,self._skillId)
