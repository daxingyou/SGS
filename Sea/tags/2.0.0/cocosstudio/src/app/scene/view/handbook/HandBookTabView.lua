...
-- i18n pos 
function HandBookTabView:_updatePosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")	
		self._textCountryProcess:setPositionX(self._textCountryNum1:getPositionX()-self._textCountryProcess:getContentSize().width)
	end
	if Lang.checkLang(Lang.EN) then
		self._textCountryNum2:setAnchorPoint(1,0.5)
		self._textCountryNum2:setPositionX(458)
		self._textCountryNum1:setAnchorPoint(1,0.5)
		self._textCountryNum1:setPositionX(self._textCountryNum2:getPositionX()-self._textCountryNum2:getContentSize().width)
		self._textCountryProcess:setAnchorPoint(1,0.5)
		self._textCountryProcess:setPositionX(self._textCountryNum1:getPositionX()-self._textCountryNum1:getContentSize().width)
	end
end
