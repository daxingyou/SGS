...
function FriendView:onCreate()
	...
	self._commonFullScreen:setCountColor(Colors.DARK_BG_THREE)
...
function FriendView:_udpateFriendListView()
	...
	self._commonFullScreen:setCount(Lang.get("lang_friend_num_limit", {num1 = friendNum, num2 = self._maxFriendNum}))
	if not Lang.checkLang(Lang.CN) then
		self._commonFullScreen:showCountPrefix(false)
	end
...
function FriendView:_updateEnemyListView()
	...
	self._commonFullScreen:showCount(true)
	self._commonFullScreen:setCount(Lang.get("lang_friend_enemy_num_limit", {num1 = #enemysData, num2 = EnemyHelper.getMaxEnemyNum()}))
	if not Lang.checkLang(Lang.CN) then
		self._commonFullScreen:showCountPrefix(false)
	end
