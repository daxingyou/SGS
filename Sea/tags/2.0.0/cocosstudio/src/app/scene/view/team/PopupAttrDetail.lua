...
-- i18n pos lable
function PopupAttrDetail:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		for i = 1, 8 do
			self["_nodeBaseAttr"..i]:setPositionX(
				self["_nodeBaseAttr"..i]:getPositionX()-15
			)
		end
		for i = 1, 12 do
			self["_nodeSeniorAttr"..i]:setPositionX(
				self["_nodeSeniorAttr"..i]:getPositionX()-15
			)
		end
		-- for i = 1, 8 do
		-- 	self["_nodeCampAttr"..i]:setFontSize(20)
	...
	if Lang.checkLang(Lang.EN) or Lang.checkLang(Lang.TH) then
		for i = 5, 8 do
			self["_nodeBaseAttr"..i]:setPositionX(290)
		end
		for i = 2, 12,2 do
			self["_nodeSeniorAttr"..i]:setPositionX(290)
		end
		for i = 5, 8 do
			self["_nodeCampAttr"..i]:setPositionX(290)
		end
	end
end
