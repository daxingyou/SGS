...
-- -- i18n change lable
function GuildRedPacketNode:_dealPosByI18n()
	if Lang.checkChannel(Lang.CHANNEL_SEA) then 
		self._textRemainNum:setPositionX(320)
		self._textRemainNum:setPositionY(405)
		self._listItemSource2:getParent():setContentSize(cc.size(600,364))
		self._listItemSource2:setContentSize(cc.size(600,364))
		local parent = self._listItemSource2:getParent()
		parent:setPositionX(parent:getPositionX()-10)
	end
end
