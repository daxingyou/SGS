...
--[[
		...
		if Lang.checkChannel(Lang.CHANNEL_SEA) then
			label4:setPositionY(label4:getPositionY()+7)
		end
...
function SeasonSportView:_dealPosByI18n()
	...
	if Lang.checkLang(Lang.EN) then 
		self._imageDivision:setPositionX(self._imageDivision:getPositionX() - 20)
		local UIHelper  = require("yoka.utils.UIHelper")
		local image1 = UIHelper.seekNodeByName(self,"Image_1")

		image1:setPositionX(image1:getPositionX() - 55)
	...
	if Lang.checkLang(Lang.TH) then
		...
		local image1 = UIHelper.seekNodeByName(self,"Image_1")
		image1:setPositionX(image1:getPositionX() - 55)
		self._commonTip:setPositionX(self._commonTip:getPositionX()+30)
	end
