...
--i18n
function PopupGuildChangeName:_dealByI18n()
	if Lang.checkLang(Lang.EN) or Lang.checkLang(Lang.TH) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local textDesc = UIHelper.seekNodeByName(self,"Text_cost_name_desc")
		textDesc:setAnchorPoint(1,0.5)
		textDesc:setPositionX(0)
	end
end
