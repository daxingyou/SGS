...
function EquipTrainStrengthenLayer:_dealPosI18n()
	...
	if Lang.checkLang(Lang.TW) then
		self._textCostTitle:setPositionX(self._textCostTitle:getPositionX()-12)
	end
...
-- i18n pos lable
function EquipTrainStrengthenLayer:_dealLevelOverlapPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		...
		self["_fileNodeAttr"]:setNextValueGap(10)
