...
-- i18n pos lable
function PopupSellFragmentCell:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
	
		self._checkBox1:setPositionX(
			self._checkBox1:getPositionX()+16
		) 
		self._checkBox2:setPositionX(
			self._checkBox2:getPositionX()+16
		) 

    end
    if Lang.checkLang(Lang.TH) then
        self._resInfoVaule1:setPositionX(self._resInfoVaule1:getPositionX()+15)
        self._resInfoVaule2:setPositionX(self._resInfoVaule2:getPositionX()+15)
    end
    if Lang.checkLang(Lang.ENID) then
        self._resInfoVaule1:setPositionX(self._resInfoVaule1:getPositionX()+70)
        self._resInfoVaule2:setPositionX(self._resInfoVaule2:getPositionX()+70)
    end
end
