...
-- i18n
function GuildHelpListCell:_dealByI18n()
	if Lang.checkLang(Lang.EN) then
		self._buttonHelp1:setPositionY(self._buttonHelp1:getPositionY()-10)
		self._buttonHelp2:setPositionY(self._buttonHelp2:getPositionY()-10)
		self._commonResInfo1:setPositionY(self._commonResInfo1:getPositionY()-10)
		self._commonResInfo2:setPositionY(self._commonResInfo2:getPositionY()-10)
	end
end

-- i18n pos lable
function GuildHelpListCell:_adjustPosByI18n(index)
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
        self["_textName"..index]:setPositionX(
			self["_textPosition"..index]:getPositionX()+self["_textPosition"..index]:getContentSize().width+8
		)
	end
end
