...
function CountryBossBigBossView:_initWidget()
	...
	if not Lang.checkLang(Lang.CN) then
		...
		self._fightCountdownBg = UIHelper.seekNodeByName(self._fightTextImage:getParent(),"Image_31")
		self._InterceptCountdownBg = UIHelper.seekNodeByName(self._InterceptTextImage:getParent(),"Image_31_0")
	end
	--挑战按钮
	...
	end,self._fightCountdownBg)--i8 更新到2.3
	--拦截按钮
	...
	end,self._InterceptCountdownBg)--i8 更新到2.3
...
-- i18n change lable
function CountryBossBigBossView:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		self._InterceptTextImage = UIHelper.swapWithLabel(self._InterceptTextImage,{
			 style = "countryboss_3",
			 text = Lang.getImgText("txt_boss_lanjie03") ,
		})

		local UIHelper  = require("yoka.utils.UIHelper")
		self._fightTextImage = UIHelper.swapWithLabel(self._fightTextImage,{
			 style = "countryboss_4",
			 text = Lang.getImgText("txt_boss_tiaozhan04") ,
		})
...
-- i18n change lable
function CountryBossBigBossView:_dealPosByI18n()
	if Lang.checkLang(Lang.EN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local endLabel = UIHelper.seekNodeByName(self._commonCountDown,"EndLabel")
		endLabel:setPositionX(0)
	end
end
