...
function ChapterView:_dealPosByI18n()
    ...
    if Lang.checkLang(Lang.EN) then
        self._textType1:setFontSize(self._textType1:getFontSize()-1)
    end

    if Lang.checkLatinLanguage() then
        self._textTitle:setPositionX( self._textTitle:getPositionX() + 10 )
        self._textTitle:setFontSize(self._textTitle:getFontSize()-2)
    end
end
