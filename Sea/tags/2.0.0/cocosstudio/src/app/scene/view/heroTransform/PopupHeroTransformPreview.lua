...
function PopupHeroTransformPreview:_initView()
	...
	srcCommon:updateUI(1, srcHeroBaseId, limitLevel)
	tarCommon:updateUI(2, tarHeroBaseId, limitLevel)
end
...
function PopupHeroTransformPreview:_updateView()
	...
	if Lang.checkLang(Lang.TH) then
		self._nodeInfo1:setPositionX(-20)
		self._nodeInfo2:setPositionX(-20)
		if self._selectTabIndex == HeroConst.HERO_TRAIN_AWAKE then
			self._nodeInfo1:setPositionX(0)
			self._nodeInfo2:setPositionX(0)
		end
	end
end
