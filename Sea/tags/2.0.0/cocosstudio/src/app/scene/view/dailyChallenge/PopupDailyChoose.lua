...
-- i18n change pos
function PopupDailyChoose:_updatePosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local textCount = UIHelper.seekNodeByName(self._panelBase,"TextCount")	
		UIHelper.alignCenter(self._panelBase,{textCount,self._textCount})
		textCount:setPositionX(textCount:getPositionX()+14)
		self._textCount:setPositionX(self._textCount:getPositionX()+14)
    end
end
