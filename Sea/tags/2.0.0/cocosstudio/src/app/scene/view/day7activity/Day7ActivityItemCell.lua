...
function Day7ActivityItemCell:_updateRewards(actTaskUnitData)
    ...
    self._commonRewardListNode:setGaps(Day7ActivityItemCell.ITEM_GAP,Day7ActivityItemCell.ITEM_ADD_GAP ,
        ...
        self._commonRewardListNode:setGaps(Day7ActivityItemCell.ITEM_GAP,Day7ActivityItemCell.ITEM_ADD_GAP ,
        Day7ActivityItemCell.ITEM_OR_GAP+8,Day7ActivityItemCell.SCROLL_WIDTH )
    end
...
-- i18n change lable
function Day7ActivityItemCell:_dealByI18n()
    ...
    if Lang.checkChannel(Lang.CHANNEL_SEA) then
        self._nodeProgressRichText:setPosition(770,102)
        self._commonButtonLevel1Normal:setPositionY(60)
        self._resourceNode:setCapInsets(cc.rect(15,15,1,1))
    end
end
