...
function ChatTabContentView:onEnter()
    ...
    if Lang.checkLang(Lang.KR) then
        self:_updateCommonEmptyListNode()
    end
end
...
-- i18n  ex
function ChatTabContentView:_createCommonEmptyListNode()
    ...
    self._imageWaterFlow:setVisible(false)
    self._imageWaterFlow = widget
end

-- i18n  ex
function ChatTabContentView:_updateCommonEmptyListNode()
    local msgList = self._chatMsgScrollView:getChatMsgList()
    self._imageWaterFlow:setVisible(#msgList <= 0)
end
