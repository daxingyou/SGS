...
-- i18n change lable
function CustomActivityHorseJudgeView:_dealByI18n()
	if Lang.checkLang(Lang.TW) then
		self._textTime:setPositionX(self._textTime:getPositionX()-40)
		self._nodeTip:setPositionX(self._nodeTip:getPositionX()-7)
	elseif Lang.checkSquareLanguage()  then
		local UIHelper  = require("yoka.utils.UIHelper")
		self._textTime:setPositionX(self._textTime:getPositionX()-57)
	elseif not Lang.checkLang(Lang.CN)  then
		local UIHelper  = require("yoka.utils.UIHelper")
        self._textTime:setPositionX(self._textTime:getPositionX()-62)
	end
end
