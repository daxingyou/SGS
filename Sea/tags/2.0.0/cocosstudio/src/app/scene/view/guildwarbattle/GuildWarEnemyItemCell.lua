...
function GuildWarEnemyItemCell:_updateHp()
	...
	local maxHp = GuildWarDataHelper.getGuildWarHp()
...
function GuildWarEnemyItemCell:_visibleBuilding(show)
	...
	self._colorProgress:setPositionX(show and 90 or 114 )
end
...
function GuildWarEnemyItemCell:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		self._textPower:setAnchorPoint(cc.p(0,0.5))
		self._textPower:setPositionX(self._textPower:getPositionX() - 8)
	end
end
