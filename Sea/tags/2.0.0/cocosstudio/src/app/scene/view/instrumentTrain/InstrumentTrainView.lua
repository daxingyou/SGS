...
function InstrumentTrainView:_updateTabIcons()
...
function InstrumentTrainView:_doLayoutTabIcons()
	...
	for i = 1, 2 do
		local txt = Lang.get("instrument_train_tab_icon_"..i)
		local isOpen = LogicCheckHelper.funcIsOpened(FunctionConst["FUNC_INSTRUMENT_TRAIN_TYPE"..i])
...
-- i18n pos lable
function InstrumentTrainView:_dealPosByI18n()
