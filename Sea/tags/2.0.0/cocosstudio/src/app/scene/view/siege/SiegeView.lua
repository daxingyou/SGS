...
function SiegeView:_dealPosByI18n()
    if Lang.checkLang(Lang.TW) or Lang.checkLang(Lang.ZH) then
	...
	if Lang.checkLang(Lang.EN) or Lang.checkLang(Lang.TH) then
		...
		if Lang.checkLang(Lang.TH) then
			self._rewardCrop:setPositionX(self._rewardCrop:getPositionX()+10)
			local text = ccui.Helper:seekNodeByName(self._rewardCrop, "Text")
			text:setPositionX(text:getPositionX()-2)
			self._rewardPersonal:setPositionX(self._rewardPersonal:getPositionX()+10)
			local text = ccui.Helper:seekNodeByName(self._rewardPersonal, "Text")
			text:setPositionX(text:getPositionX()-2)
		end
	end
end
