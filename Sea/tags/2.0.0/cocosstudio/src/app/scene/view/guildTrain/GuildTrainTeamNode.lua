...
function GuildTrainTeamNode:_updatePosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local text1 = UIHelper.seekNodeByName(self._timeLabel,"text1")
		local text2 = UIHelper.seekNodeByName(self._timeLabel,"text2")
		UIHelper.alignCenter( self._timeLabel,{text1,text2})
	end
end
