...
--i18n
function PopupHonorTitle:_dealByI18n()
    if Lang.checkChannel(Lang.CHANNEL_SEA) then
        self._titleName:setAnchorPoint(0.5,0.5)
        self._titleName:setPositionX(100)
        self._titleChapter:setAnchorPoint(0.5,0.5)
        self._titleChapter:setPositionX(317)
        self._titleChapter_0:setAnchorPoint(0.5,0.5)
        self._titleChapter_0:setPositionX(515)
    end
end
