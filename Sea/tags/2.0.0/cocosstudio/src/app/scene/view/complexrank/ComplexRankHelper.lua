...
function ComplexRankHelper.getComplexTab()
	local list = {
		Lang.get("complex_rank_tab1"),
		Lang.get("complex_rank_tab2"),
		Lang.get("complex_rank_tab3"),
		Lang.get("complex_rank_tab4"),
		Lang.get("complex_rank_tab5"),
		Lang.get("complex_rank_tab6"),
		Lang.get("complex_rank_tab7"),
		Lang.get("complex_rank_tab8")
	}
	local ComplexRankConst = require("app.const.ComplexRankConst")

	local indexlist = {
		{Lang.get("complex_rank_tab1"), ComplexRankConst.USER_LEVEL_RANK},
		{Lang.get("complex_rank_tab2"), ComplexRankConst.USER_POEWR_RANK},
		{Lang.get("complex_rank_tab3"), ComplexRankConst.USER_GUILD_RANK},
		{Lang.get("complex_rank_tab4"), ComplexRankConst.USER_ARENA_RANK},
		{Lang.get("complex_rank_tab5"), ComplexRankConst.STAGE_STAR_RANK},
		{Lang.get("complex_rank_tab6"), ComplexRankConst.ELITE_STAR_RANK},
		{Lang.get("complex_rank_tab7"), ComplexRankConst.TOWER_STAR_RANK},
		{Lang.get("complex_rank_tab8"), ComplexRankConst.ACTIVE_PHOTO_RANK}
	}
...
function ComplexRankHelper.covertServerData(id, message)
	...
	if
		id == SignalConst.EVENT_COMPLEX_POWER_RANK or id == SignalConst.EVENT_COMPLEX_LEVEL_RANK or
			...
			id == SignalConst.EVENT_COMPLEX_ACTIVE_PHOTO_RANK
	 then
