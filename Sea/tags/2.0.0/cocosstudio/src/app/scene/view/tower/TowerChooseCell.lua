...
function TowerChooseCell:_adjustPosI18n()
	if not Lang.checkLang(Lang.CN)  then
		...
		if Lang.checkLang(Lang.EN) then
			self._reward1:setPositionX(self._reward1:getPositionX()+15)
			self._reward2:setPositionX(self._reward2:getPositionX()+15)
		else
		...
		if Lang.checkChannel(Lang.CHANNEL_SEA) then
			local textBG = UIHelper.seekNodeByName(nodeBG,"TextBG")
			textBG:setPositionY(textBG:getPositionY()+5)
			local textBG2 = UIHelper.seekNodeByName(nodeBG,"TextBG2")
			textBG2:setPositionY(textBG2:getPositionY()+5)
			self._btnFight:setPositionY(self._btnFight:getPositionY()+10)
			for i = 1, 3 do
				self["_starNode"..i]:setPositionY(self["_starNode"..i]:getPositionY()+5)
			end
			textPower:setPosition(108,37)
			self._textPower:setPosition(108,16)
		end
	end
end
