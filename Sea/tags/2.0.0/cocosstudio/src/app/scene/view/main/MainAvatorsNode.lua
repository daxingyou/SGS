...
function MainAvatorsNode:_updateHeroAvatar()
    ...
    for i, value in ipairs(heroIdList) do
        ...
        if heroUnit and heroNode then
            ...
            heroNode:updateUI(heroBaseId, isEquipAvatar, limitLevel)
            heroNode:updateHeroName(heroUnit:getBase_id(), heroUnit:getRank_lv(),heroUnit:getLevel(), heroUnit:getLimit_level())
