...
--i18n
function Day7ActivityDiscountView:_dealByI18n()
	if Lang.checkChannel(Lang.CHANNEL_SEA) then
        self._newPrice:setPositionX(self._newPrice:getPositionX()+15)
        self._newResIcon:setPositionX(self._newResIcon:getPositionX()+15)
	end
	
	if Lang.checkChannel(Lang.CHANNEL_SEA) then
		self._itemParent:setPositionY(self._itemParent:getPositionY()+35)
	end

	if Lang.checkLang(Lang.EN) then
		self._oldPrice:setPositionX(self._oldPrice:getPositionX()+10)
		self._oldResIcon:setPositionX(self._oldResIcon:getPositionX()+10)
	end
end
