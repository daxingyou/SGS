...
function FriendList:_onBtnAddFriend()
	...
	local popup = nil
	 if not Lang.checkLang(Lang.CN) then
		...
		local len = UIHelper.getInputLimitedConfig().role_length
		popup = PopupInput.new(function(name)
		...
		end,nil, Lang.get("lang_friend_btn_add"), Lang.get("lang_friend_input_tips"), Lang.get("lang_friend_input_tips"),Lang.get("lang_friend_input_placeholder"),len)	
	else
		popup = PopupInput.new(function(name)
			if G_UserData:getBase():getName() == name then
				G_Prompt:showTip(Lang.get("lang_friend_add_friend_not_self"))
