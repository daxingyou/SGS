...
function PopupHomelandSubUp:_updateSubTreeCondition( subData1,subData2 )
	...
	local function updateSubTreeLimit(rootNode, value )
		...
		if not Lang.checkLang(Lang.CN)  then
			...
			textName:setPositionX(3)
			textLevel:setPositionX(textName:getPositionX()+textName:getContentSize().width+5)
			button:setAnchorPoint(cc.p(1,0.5))
			button:setPositionX(363)
		end
...
-- i18n pos lable
function PopupHomelandSubUp:_dealPosI18n()
	if not Lang.checkLang(Lang.CN)  then
		self["_resSubItem1"]:setPositionX(self["_resSubItem1"]:getPositionX() - 22)
		self["_resSubItem2"]:setPositionX(self["_resSubItem2"]:getPositionX() - 6 )

		self._textRankMax:setPositionX(self._textRankMax:getPositionX()+20)
	end
	if Lang.checkLang(Lang.EN) or Lang.checkLang(Lang.TH) then
		self["_resSubItem2"]:setPositionX(self["_resSubItem2"]:getPositionX() - 6 )
		for i = 1, 2 do
			local name = ccui.Helper:seekNodeByName(self["_resSubItem"..i], "TextName")
			name:setPositionX(name:getPositionX()-4)
			local num = ccui.Helper:seekNodeByName(self["_resSubItem"..i], "NodeNumPos")
			num:setPositionX(num:getPositionX()-4)
		end
	end
	if Lang.checkLang(Lang.ENID) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local Text_11_4= UIHelper.seekNodeByName(self,"Text_11_4")
		local Text_11_4_0= UIHelper.seekNodeByName(self,"Text_11_4_0")
		Text_11_4:setFontSize(Text_11_4:getFontSize()-3)
		Text_11_4_0:setFontSize(Text_11_4_0:getFontSize()-3)
	end
end
