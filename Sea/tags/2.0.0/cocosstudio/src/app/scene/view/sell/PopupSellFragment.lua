...
--i18n
function PopupSellFragment:_dealByI18n()
    if Lang.checkLang(Lang.TH) then
        self._totalGet:setPositionX(self._totalGet:getPositionX()+15)
        self._totalGet1:setPositionX(self._totalGet1:getPositionX()+15)
    end
    if Lang.checkLang(Lang.ENID) then
        self._totalGet:setPositionX(self._totalGet:getPositionX()+80)
        self._totalGet1:setPositionX(self._totalGet1:getPositionX()+80)
    end
end
