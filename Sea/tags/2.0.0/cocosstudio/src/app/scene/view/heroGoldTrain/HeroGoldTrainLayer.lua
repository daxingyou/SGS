...
function HeroGoldTrainLayer:_updateTalentDes()
    ...
    local config = UserDataHelper.getHeroRankConfig(self._heroUnitData:getBase_id(), talentLevel, limitLevel)
...
--i18n
function HeroGoldTrainLayer:_dealByI18n()
    if Lang.checkHorizontal() then
        ...
        local text = ccui.Helper:seekNodeByName(self._nodeSilver, "Text_2")
        text:setAnchorPoint(1,0.5)
        text:setPosition(95,13)
    end
end
