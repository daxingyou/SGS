...
-- i18n change lable
function PopupGuildWarCityInfo:_dealByI18n()
	if not Lang.checkLang(Lang.CN)  then
		local UIHelper  = require("yoka.utils.UIHelper")
        self._textProclaimNum:setPositionX(self._textProclaimNum:getPositionX()+38)
	end
end


-- i18n pos 
function PopupGuildWarCityInfo:_updatePosByI18n()
	if Lang.checkLang(Lang.TH)  then
		local UIHelper  = require("yoka.utils.UIHelper")
		local text = UIHelper.seekNodeByName(self._panelBg,"Text_96_0")
		UIHelper.alignCenter(self._panelBg,{text,self._textProclaimNum})
	end
end
