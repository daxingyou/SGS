...
function ComponentBattleDesc:_createCsbNode()
    ...
    if self._type == ComponentBattleDesc.TYPE_NORMAL then
        ...
        if self._battleData.defenseOffLevel then
            ...
            -- self._playerName:enableOutline(Colors.getOfficialColorOutline(self._battleData.defenseOffLevel) , 2)
        end
        ...
        if Lang.checkLang(Lang.TH) or Lang.checkLang(Lang.EN) then
            ...
            UIHelper.alignCenter(panel,{self._textDesc,self._playerName},{2,0})
        end
