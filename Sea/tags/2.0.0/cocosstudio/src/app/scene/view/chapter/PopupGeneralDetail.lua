...
-- i18n change lable
function PopupGeneralDetail:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then

        local UIHelper  = require("yoka.utils.UIHelper")	
        self._imagePass = UIHelper.swapSignImage(self._imagePass,
		{ 
			 style = "signet_8", 
			 text = Lang.getImgText("img_seal_yitongguan01") ,
...
-- i18n pos lable
function PopupGeneralDetail:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
        local UIHelper  = require("yoka.utils.UIHelper")
