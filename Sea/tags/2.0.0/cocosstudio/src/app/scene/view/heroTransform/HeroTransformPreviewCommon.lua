...
function HeroTransformPreviewCommon:updateUI(type, heroBaseId, limitLevel)
	if type == 1 then
	...
	self._nodeHeroIcon:updateUI(heroBaseId, nil, limitLevel)
	self._nodeHeroName:setName(heroBaseId, nil, limitLevel)
