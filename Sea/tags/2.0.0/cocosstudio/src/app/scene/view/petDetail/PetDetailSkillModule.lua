...
function PetDetailSkillModule:ctor(skillIds, showSkillDetail,petBaseId, petStar)
...
function PetDetailSkillModule:onCreate()
	...
	for i, skillId in ipairs(self._skillIds) do
		local cell = PetDetailSkillCell.new(skillId,self._showSkillDetail,self._petBaseId, self._petStar)
