...
local pvppro_parameter = {
    _data = {
        ...
        [42] = {42,"pvpsingle_reward","11|1401,11|1402,11|1403,6|43,6|556,6|555,6|701,6|702,6|703,6|704",},
...
function pvppro_parameter.indexOf(index)
    ...
    if Lang.lang ~= "cn" and Lang.lang ~= _lang then 
        _lang = Lang.lang 
        if Lang.isFileExist("app/i18n/".. _lang .."/config/pvppro_parameter.lua") then _isExist =  true end
    end
    if _lang ~= "cn" and _isExist then
        local table = require( "app.i18n.".. _lang ..".config." .. "pvppro_parameter" )
        return setmetatable({_raw = pvppro_parameter._data[index], _lang=table._data[index], _lang_key_map=table.__key_map}, mt)
    end
