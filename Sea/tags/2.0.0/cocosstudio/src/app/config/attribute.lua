...
local attribute = {
    _data = {
        ...
        [52] = {101,1,"天赋战力","talent_power",48,201,},
        [53] = {102,1,"官衔战力","official_power",49,202,},
        [54] = {103,2,"神兽护佑","pet_protect",50,0,},
        [55] = {104,2,"神兽全属性","pet_attribute",51,0,},
        [56] = {105,1,"总战力","all_combat",52,0,},
        [57] = {106,1,"变身卡图鉴战力","avatar_power",52,203,},
        [58] = {107,1,"神兽图鉴战力","pet_power",53,204,},
        [59] = {108,1,"锦囊战力","silkbag_power",54,205,},
        [60] = {109,1,"变身卡战力","avatar_equip_power",55,206,},
        [61] = {110,1,"神兽初始假战力","pet_initial_power",56,207,},
        [62] = {111,2,"装饰属性","tree_attribute",57,0,},
        [63] = {112,2,"兽魂产量","output_pet",58,0,},
        [64] = {113,1,"神树战力","tree_power",59,208,},
        [65] = {114,1,"战马战力","horse_power",60,209,},
        [66] = {115,1,"玉石战力","jade_power",61,210,},
    }
}
...
function attribute.indexOf(index)
    ...
    if Lang.lang ~= "cn" and Lang.lang ~= _lang then 
        _lang = Lang.lang 
        if Lang.isFileExist("app/i18n/".. _lang .."/config/attribute.lua") then _isExist =  true end
    end
    if _lang ~= "cn" and _isExist then
        local table = require( "app.i18n.".. _lang ..".config." .. "attribute" )
        return setmetatable({_raw = attribute._data[index], _lang=table._data[index], _lang_key_map=table.__key_map}, mt)
    end
