...
local pet_exp = {
    _data = {
        ...
        [578] = {98,6,95000,1000,},
        [579] = {99,6,96000,1000,},
        [580] = {100,6,97000,1000,},
        [581] = {101,6,97900,1000,},
        [582] = {102,6,98900,1000,},
        [583] = {103,6,99800,1000,},
        [584] = {104,6,100800,1000,},
        [585] = {105,6,101800,1000,},
        [586] = {106,6,102700,1000,},
        [587] = {107,6,103700,1000,},
        [588] = {108,6,104600,1000,},
        [589] = {109,6,105600,1000,},
        [590] = {110,6,106600,1000,},
        [591] = {111,6,107500,1000,},
        [592] = {112,6,108500,1000,},
        [593] = {113,6,109400,1000,},
        [594] = {114,6,110400,1000,},
        [595] = {115,6,111400,1000,},
        [596] = {116,6,112300,1000,},
        [597] = {117,6,113300,1000,},
        [598] = {118,6,114200,1000,},
        [599] = {119,6,115200,1000,},
        [600] = {120,6,116150,1000,},
    }
}
...
function pet_exp.indexOf(index)
    ...
    if Lang.lang ~= "cn" and Lang.lang ~= _lang then 
        _lang = Lang.lang 
        if Lang.isFileExist("app/i18n/".. _lang .."/config/pet_exp.lua") then _isExist =  true end
    end
    if _lang ~= "cn" and _isExist then
        local table = require( "app.i18n.".. _lang ..".config." .. "pet_exp" )
        return setmetatable({_raw = pet_exp._data[index], _lang=table._data[index], _lang_key_map=table.__key_map}, mt)
    end
