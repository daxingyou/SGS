...
local play_horse_player = {
    _data = {
        ...
        [12] = {12,500,1,"181,200|161,180|141,160|121,140|101,120|81,100|61,80|41,60|21,40|1,20","为比赛而热血，就算输了也无所谓！","魏延的晕眩减怒可好用了！","谁能告诉我，到底哪个阵营更厉害？","拼将一死酬知己，致令千秋仰义名。",},
        ...
        [40] = {40,250,1,"181,200|161,180|141,160|121,140|101,120|81,100|61,80|41,60|21,40|1,20","曹丕合击搂甄姬的腰，他肯定跑不快！","曾梦想仗剑走天涯，后来工作忙没去，因为一直玩游戏。","鲁肃也能晕眩减怒！","弦歌知雅意，杯酒谢良朋。",},
...
function play_horse_player.indexOf(index)
    ...
    if Lang.lang ~= "cn" and Lang.lang ~= _lang then 
        _lang = Lang.lang 
        if Lang.isFileExist("app/i18n/".. _lang .."/config/play_horse_player.lua") then _isExist =  true end
    end
    if _lang ~= "cn" and _isExist then
        local table = require( "app.i18n.".. _lang ..".config." .. "play_horse_player" )
        return setmetatable({_raw = play_horse_player._data[index], _lang=table._data[index], _lang_key_map=table.__key_map}, mt)
    end
