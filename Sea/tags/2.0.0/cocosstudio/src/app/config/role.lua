...
local role = {
    _data = {
        ...
        [120] = {120,2690000,50,10,500,500,500,500,120,500,500,12,2190,120,240,30,47,20,75,120,},
    }
}
...
function role.indexOf(index)
    ...
    if Lang.lang ~= "cn" and Lang.lang ~= _lang then 
        _lang = Lang.lang 
        if Lang.isFileExist("app/i18n/".. _lang .."/config/role.lua") then _isExist =  true end
    end
    if _lang ~= "cn" and _isExist then
        local table = require( "app.i18n.".. _lang ..".config." .. "role" )
        return setmetatable({_raw = role._data[index], _lang=table._data[index], _lang_key_map=table.__key_map}, mt)
    end
