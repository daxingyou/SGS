...
local horse = {
    _data = {
        ...
        [9] = {9,"飞霜千里",5,5,"809","飞霜千里，身体雪白似冰霜，神秘轻盈，行万里不知疲惫，所过之处如飞霜过境，寒气逼人，让人无法靠近。",120009,"辅助类","103|110|112|117|118|204|211|304|315|350|404|412|417",40,"effect_taozhuang_orange","Horse_Orange_win_01",},
        [10] = {10,"乌云踏雪",5,5,"812","乌云踏雪，通体如黑缎子一般，油光放亮，唯有四个马蹄部位白得赛雪，背长腰短而平直，四肢关节筋腱发育壮实，身覆重甲，从一而终。",120010,"输出类","1|2|3|4|5|11|12|13|14|15|101|107|108|109|111|113|114|150|201|205|206|208|209|213|217|218|250|301|306|308|310|316|318|350|403|406|407|410|413|414|416|450",40,"effect_taozhuang_orange","Horse_Orange_win_04",},
        [11] = {11,"胭脂火龙",5,5,"811","胭脂火龙，浑身上下，火炭般赤，无半根杂毛，嘶喊咆哮，有腾空入海之状，鬃卷似江波，又如少女发丝般柔软，行速如飞，过川登山，如履平地。",120011,"治疗类","102|202|302|402|216",40,"effect_taozhuang_orange","Horse_Orange_win_03",},
        [12] = {12,"夜照玉狮",5,5,"810","夜照玉狮，一色雪白，仅脖子尾巴覆金色毛发，大蹄，宛如雄狮一般，性格暴烈，既能日行千里，亦能跨越天险，出入战场如入无人之境。",120012,"辅助、控制类","103|106|110|112|115|116|117|118|150|203|204|210|211|212|214|219|304|307|312|315|317|350|401|404|408|409|411|412|415|419|417",40,"effect_taozhuang_orange","Horse_Orange_win_02",},
...
function horse.indexOf(index)
    ...
    if Lang.lang ~= "cn" and Lang.lang ~= _lang then 
        _lang = Lang.lang 
        if Lang.isFileExist("app/i18n/".. _lang .."/config/horse.lua") then _isExist =  true end
    end
    if _lang ~= "cn" and _isExist then
        local table = require( "app.i18n.".. _lang ..".config." .. "horse" )
        return setmetatable({_raw = horse._data[index], _lang=table._data[index], _lang_key_map=table.__key_map}, mt)
    end
