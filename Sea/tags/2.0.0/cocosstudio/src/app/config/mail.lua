...
local mail = {
    _data = {
        ...
        [65] = {70,1,1,"军团管家","军功宝箱",0,"主公，您在本次跨服军团战中表现活跃，英勇杀敌，特发放如下奖励，请查收！",},
        [66] = {75,1,1,"小乔","礼包码奖励",0,"亲爱的主公，以下是您领取的OPPO专属礼包奖励，请注意查收！感谢您对我们游戏的支持，祝您游戏愉快！",},
        ...
        [74] = {83,1,1,"小乔","周年庆红包雨即将开启",0,"主公，周年庆红包雨活动即将在#time#开启，恭请各位主公驾临！",},
        ...
        [83] = {91,1,1,"小乔","军团进入跨服周年庆",0,"恭喜主公所在的#name1#军团在本服周年庆中斩获第#rank#名，将代表本服参加跨服周年庆！请继续加油为军团争光！",},
        [84] = {92,1,1,"小乔","本服周年庆个人奖励",0,"恭喜主公在本服周年庆中斩获个人排名第#rank#名！附件是您的排名奖励，请查收！",},
        [85] = {93,1,1,"小乔","本服周年庆军团奖励",0,"恭喜主公所在的#name1#军团在本服周年庆中斩获第#rank#名！附件是您的军团排名奖励，请查收！",},
        [86] = {94,1,1,"小乔","跨服周年庆个人奖励",0,"恭喜主公在跨服周年庆中斩获个人排名第#rank#名！附件是您的排名奖励，请查收！",},
        [87] = {95,1,1,"小乔","跨服周年庆军团奖励",0,"恭喜主公所在的#name1#军团在跨服周年庆中斩获第#rank#名！附件是您的军团排名奖励，请查收！",},
        [88] = {96,1,1,"小乔","本服周年庆蛋糕奖励",0,"本服周年庆已结束，附件是您未领取的蛋糕升级奖励，请注意查收！",},
        [89] = {97,1,1,"小乔","跨服周年庆蛋糕奖励",0,"跨服周年庆已结束，附件是您未领取的蛋糕升级奖励，请注意查收！",},
        [90] = {8401,1,2,"小乔","充值提醒",0,"您于#time#，在官网上购买了#name#，对应奖励已直接发放到您指定账户，同时激活当天对应累充活动；以下是本次网页充值的额外奖励，感谢您的支持！",},
        [91] = {8402,1,2,"小乔","充值提醒",0,"您于#time#，在官网上购买了#name#，部分奖励已直接发放到您账户，基金月卡类请到游戏内对应界面领取，同时激活当天对应累充活动；以下是本次网页充值的额外奖励，感谢您的支持！",},
        [92] = {8403,1,1,"小乔","贵宾VIP认证见面礼",0,"亲爱的主公，您已开启《三国杀名将传》VIP贵宾绿色通道，请收下我们的认证礼包，之后新版本内容、新活动讯息也会第一时间通知您！感谢您对《三国杀名将传》的支持与热爱，祝主公游戏愉快！",},
        [93] = {8404,1,1,"小乔","商店评论奖励",0,"亲爱的主公，感谢您对于我们游戏的支持，请收下小乔准备的奖励！祝您游戏愉快~~~",},
        [94] = {8405,1,1,"小乔","事前预约#sub_num#万奖励",0,"感謝各位主公的熱情參與，預約人數突破#sub_num#萬次，以下是預約獎勵，請注意查收，祝您游戲愉快~",},
    }
}
...
function mail.indexOf(index)
    ...
    if Lang.lang ~= "cn" and Lang.lang ~= _lang then 
        _lang = Lang.lang 
        if Lang.isFileExist("app/i18n/".. _lang .."/config/mail.lua") then _isExist =  true end
    end
    if _lang ~= "cn" and _isExist then
        local table = require( "app.i18n.".. _lang ..".config." .. "mail" )
        return setmetatable({_raw = mail._data[index], _lang=table._data[index], _lang_key_map=table.__key_map}, mt)
    end
