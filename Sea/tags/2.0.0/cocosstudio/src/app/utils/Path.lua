...
local SERVER_STATUS_IMGS = {"","smooth","server_hot","server_weihu","server_weihu","server_weihu","smooth","smooth","","","server_xianxing02"}
local SERVER_STATUS_IMGS_2 = {"","server_xinfu","server_huobao","server_preserve","server_preserve","server_preserve","server_xinfu","server_xinfu","","","server_xianxing"}
...
function Path.getShareImage(id)
