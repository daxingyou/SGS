...
ColorNew.NUMBER_QUALITY = {
    ...
    cc.c3b(0xff, 0xff, 0xff), --金色----未提供金色
}
...
ColorNew.NUMBER_QUALITY_OUTLINE = {
    ...
    cc.c4b(0xef, 0xba, 0x00, 0xff), --金色----未提供金色
}
---C类：标题字色
...
ColorNew.BUTTON_ONE_NORMAL = cc.c3b(0xc4, 0x4a, 0x00) --普通样式字色

ColorNew.BUTTON_ONE_NOTE = cc.c3b(0xac, 0x56, 0x1a) --强调样式字色
...
ColorNew.COLOR_OFFICIAL_RANK = {
    ...
    cc.c3b(0x00, 0xba, 0xff), -- 蓝
    cc.c3b(0x11, 0x7b, 0xde), -- 蓝
    cc.c3b(0xf5, 0x70, 0xd4), -- 淡粉
    cc.c3b(0xff, 0x0e, 0xe5), -- 淡粉
    cc.c3b(0xce, 0x1d, 0xd6), -- 深粉
    cc.c3b(0xa3, 0x1e, 0xff), -- 深粉
    cc.c3b(0xff, 0xcc, 0x00), -- 淡黄
    cc.c3b(0xff, 0xae, 0x00), -- 淡黄
    cc.c3b(0xff, 0x84, 0x00), -- 深黄
    cc.c3b(0xff, 0x48, 0x00), -- 深黄
    cc.c3b(0xf9, 0x5a, 0x69), -- 红
    cc.c3b(0xff, 0x00, 0x00) -- 红
}

ColorNew.COLOR_OFFICIAL_RANK_OUTLINE = {
    cc.c3b(0x00, 0x45, 0x18), -- 绿
    cc.c3b(0x01, 0x27, 0xa4), -- 蓝
    cc.c3b(0x01, 0x27, 0xa4), -- 蓝
    cc.c3b(0x4d, 0x18, 0x56), -- 淡粉
    cc.c3b(0x4d, 0x18, 0x56), -- 淡粉
    cc.c3b(0x4b, 0x00, 0x71), -- 深粉
    cc.c3b(0x4b, 0x00, 0x71), -- 深粉
    cc.c3b(0x79, 0x36, 0x00), -- 淡黄
    cc.c3b(0x79, 0x36, 0x00), -- 淡黄
    cc.c3b(0x7d, 0x2e, 0x07), -- 深黄
    cc.c3b(0x7d, 0x2e, 0x07), -- 深黄
    cc.c3b(0x67, 0x08, 0x06), -- 红
    cc.c3b(0x67, 0x08, 0x06) -- 红
}
