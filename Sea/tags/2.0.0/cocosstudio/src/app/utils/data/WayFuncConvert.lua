...
function WayFuncConvert._FUNC_RECHARGE()
	local returnFunc = function(...)
		...
		G_SceneManager:showDialog("app.scene.view.vip.VipView")
		--
		--[[
...
function WayFuncConvert._FUNC_GACHA_GOLDENHERO( ... )
	...
	local returnFunc = function ( ... )
		-- body
		G_SceneManager:showScene("gachaGoldHero")
	end
	return returnFunc
end
...
function WayFuncConvert._FUNC_EQUIP_TRAIN_TYPE3( ... )
	...
	local returnFunc = function(...)
		...
		local tabIndex = PackageHelper.getPackTabIndex(PackageViewConst.TAB_JADESTONE)
