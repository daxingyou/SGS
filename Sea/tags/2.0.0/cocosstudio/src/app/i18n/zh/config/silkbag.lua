...
local silkbag = {
    ...
    _data = {
        ...
        [29] = {1224,"甄姬锦囊","技能伤害转化治疗比例提升","技能伤害转化为血量治疗当前血量最少的武将的比例提升18%.(只对当前有技能转治疗的辅助武将生效)","技能伤害转化治疗比例提升","去穿戴",7,"103|112|117|204|211|404|412",1,},
        ...
        [46] = {1316,"青青子衿锦囊","回合结束回复悠悠我心1点怒气","该武将每回合首次出手后, 佩戴悠悠我心锦囊的武将可额外获得1点怒气.(每套阵容限定1名男性武将佩戴)","回合结束回复悠悠我心1点怒气","去穿戴",21,"998",0,},
        [47] = {1317,"悠悠我心锦囊","回合结束回复青青子衿1点怒气","该武将每回合首次出手后, 佩戴青青子衿锦囊的武将可额外获得1点怒气.(每套阵容限定1名女性武将佩戴)","回合结束回复青青子衿1点怒气","去穿戴",21,"997",0,},
        ...
        [50] = {1401,"七杀锦囊","造成的伤害被分摊比例下降","我方纵排, 前排, 后排输出武将对敌方造成的伤害如果被分摊, 其分摊的比例降低50%","我方纵排, 前排, 后排输出武将对敌方造成的伤害如果被分摊, 其分摊的比例降低50%","去穿戴",21,"107|108|109|113|114|201|206|208|209|217|218|301|306|318|406|407|414|416",2,},
        [51] = {1402,"贪狼锦囊","击杀目标获得怒气","技能直接击杀敌方目标时, 获得目标剩余的所有怒气(输出武将佩戴)","击杀敌方目标时, 获得目标剩余的所有怒气(输出武将佩戴)","去穿戴",21,"101|107|108|109|111|113|114|201|205|206|208|209|217|218|301|306|308|310|316|318|403|406|407|410|413|414|416",2,},
        [52] = {1403,"传说·关羽锦囊","初始怒气增加2点","初始怒气增加2点","初始怒气增加2点","去穿戴",21,"999",2,},
