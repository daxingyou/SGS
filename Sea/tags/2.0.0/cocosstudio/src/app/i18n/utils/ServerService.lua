        ...
        if #list == 4 then
            ...
            if surName and name and (sex == 1 or sex == 2) then
                ...
                if Lang.checkLang(Lang.EN) or Lang.checkLang(Lang.TH) then
                    if sex == 1 then
                        result = result .. name.name_boy .. surName.surname
                    else
                        result = result .. name.name_girl .. surName.surname
                    end
                else
                    if sex == 1 then
...
function ServerService:_dealChannelStr(msgId,content)
    ...
    local filterFieldName = {server_name=true,real_server_name=true,sname = true,svr_name = true}
