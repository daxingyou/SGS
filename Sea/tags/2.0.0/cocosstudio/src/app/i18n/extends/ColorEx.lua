...
ColorEx.TextStyle =
{
    ...
    ["guild_dungeon_1"] = { typeConst = TypeConst.FONT_TITLE, size = 18, outlineSize = 1, color = cc.c3b(0xff, 0xfb, 0x79), outlineColor =  cc.c3b(0x80, 0x31, 0x12)},   --军团副本  积分、名次、 出手、 伤害 
    ...
    ["icon_txt_20"] = { typeConst = TypeConst.FONT_TITLE, size = 22, outlineSize = 2, color = cc.c3b(0xff , 0xe4  , 0x00), outlineColor =  cc.c3b(0x6f  , 0x2b  , 0x01  )},   -- function_level 20 tw
    ["icon_txt_30"] = { typeConst = TypeConst.FONT_TITLE, size = 24, outlineSize = 2, color = cc.c3b(0xff , 0xc0  , 0x2a), outlineColor =  cc.c3b(0x30  , 0x08  , 0x00  )},   -- function_level 30 tw
