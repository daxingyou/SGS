...
NativeConst.SDKTranslateWithTextResult      = "SDKTranslateWithTextResult"--i18n


-- ios推送token
NativeConst.DeviceToken					    = "DeviceToken"
--渠道sdk绑定游客账户
NativeConst.SDKBindGuestResult		        = "SDKBindGuestResult"   
