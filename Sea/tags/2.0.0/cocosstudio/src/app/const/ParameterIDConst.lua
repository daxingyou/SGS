...
-- 跨服军团战
ParameterIDConst.GUILDCROSS_OPEN_WEEK          = 452 -- 跨服军团战周几开
...
--ParameterIDConst.MINE_CRAFT_PRIVILEGE_RESET     = 621 -- 续费按钮出现倒数天数
...
--ParameterIDConst.MINE_CRAFT_VIPLEVELLIMIT       = 627 -- 矿战特权贵族等级限制
...
--矿战碾压 --i18n 同步1.12 矿战碾压
ParameterIDConst.POWER_GAP = 736 --i18n 同步1.12 矿战碾压
