...
ChatConst.CHANNEL_VOICE_PNGS = {"img_chat04", "img_chat04", "img_chat03", "img_chat04", "img_chat04", "img_chat05"}

ChatConst.MAX_MSG_CACHE_NUM = {50, 50, 50, 50, 50, 50} --聊天最大缓存数量
