...
function TopLevelNode:ctor()
   ...
   --
    ...
    self._drawNodeLeft:setPosition(cc.p(width*0.5-568, display.cy))
    ]]
    --[[
    ...
    self._drawNodeRight:setPosition(cc.p(width*0.5+568, display.cy))
    --]]
...
function TopLevelNode:getRootNode()
    return self._root
end
