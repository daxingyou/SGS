...
-- function UIHelper.createBMFLabel(params)
--     local fontPath = params.fontName or Path.getImgFont("skill")
--     local text = params.text or ""
-- 	local uiText = ccui.TextBMFont:create(text, fontPath)
--     local renderLabel = uiText:getVirtualRenderer()

--     if params.fontSize ~= nil then
--         renderLabel:setBMFontSize(params.fontSize)
--     end
    
--     if params.lineSpacing ~= nil then
--         renderLabel:setLineSpacing(params.lineSpacing)
--     end
    
--     if params.width ~= nil then
--         renderLabel:setWidth(params.width)
--     end
...
function UIHelper.createRichItems(paramsTable,adaptSize)
    ...
    for i, value in ipairs(paramsTable) do
        ...
        rangSize.width = rangSize.width + widgetSize.width
