...
function PopupStoryChatNode:onCreate()
    if Lang.checkUI("ui4") then
        ...
        self._avatarTalker:setPositionY(-size.height/2)
    end
    ...
    if self._heroId == 1 then
        self._avatarTalker:updateChatUI(self._myHeroId) -- i18n ja mouth
        ...
        self._avatarTalker:updateChatUI(self._heroId)   -- i18n ja mouth
    end
...
-- i18n ja mouth
function PopupStoryChatNode:playMouthAnimationOnceWithCallback(callback)
    self._avatarTalker:playPointAnimationOnceWithCallback("mouth","talk",callback)
end
-- i18n ja mouth
function PopupStoryChatNode:playCloseMouthAnimationForever()
    self._avatarTalker:playPointDefaultAnimation("mouth")
end
