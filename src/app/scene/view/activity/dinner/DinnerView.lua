...
function DinnerView:_dealI18n()
	if not Lang.checkLang(Lang.CN) then
		...
		if Lang.checkUI("ui4") then
			for i = 1, 3 do
				self["_textDinnerName0"..i]:setPositionX(self["_textDinnerName0"..i]:getPositionX() - 8)
				self["_textDinnerTime0"..i]:setAnchorPoint(1,0.5)
				self["_textDinnerTime0"..i]:setPositionX(225)
			end
