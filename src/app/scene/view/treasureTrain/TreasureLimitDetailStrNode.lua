...
function TreasureLimitDetailStrNode:onCreate()
	...
	self._listView1:setPosition(cc.p(posList1X, posYListView1)) -- i18n ja change 因为listview位置设置问题 导致右边六有间隙
...
function TreasureLimitDetailStrNode:_updateSubView(index)
	...
	if attrInfo then -- i18n ja change
...
function TreasureLimitDetailStrNode:_createTitle(index)
	...
	local widgetSize = cc.size(402+4, 34 + 10)
