...
function PopupGuildDungeonRecord:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local text1 = UIHelper.seekNodeByName(self, "Text_13")
		local text2 = UIHelper.seekNodeByName(self, "Text_13_0")
		UIHelper.alignCenterToFixPos(246,{text1,self._textPoint,text2,self._textCount},{0,20,0,0})
		if Lang.checkUI("ui4") then
			UIHelper.alignCenterToFixPos(246,{text1,self._textPoint,text2,self._textCount},{10,20,10,0})
		end
	end
end
