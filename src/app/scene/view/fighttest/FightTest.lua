...
function FightTest:ctor()
	...
	local path = FileUtils:getWritablePath() ..  "userdata/"..FightTest.CONFIG.report..".lua"
...
function FightTest:_checkHeroShow(waveId)
	...
	if waveId == self._engine:getWaveCount() then
		...
		if Lang.checkUI("ui4") then
			heroShow = HeroShow.create(showId, function() self:_heroShowEnd(waveId) end, true, true,true)
		else
