...
if not Lang.checkLang(Lang.CN) and not Lang.checkLang(Lang.VN) and not Lang.checkLang(Lang.JA) then
    local jadeTable = HandBookHelper.TAB_LIST[HandBookHelper.TBA_JADE_STONE]
    table.remove(jadeTable)
    table.remove(jadeTable)
end
