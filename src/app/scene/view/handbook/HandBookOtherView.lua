...
-- i18n change lable
function HandBookOtherView:_dealByI18n()
	if not Lang.checkLang(Lang.CN)  then
		local UIHelper  = require("yoka.utils.UIHelper")
		self._textCountryProcess:setPositionX(self._textCountryProcess:getPositionX() + 100 )	
		self._textCountryProcess:setAnchorPoint(cc.p(1,0.5))
	end
end
