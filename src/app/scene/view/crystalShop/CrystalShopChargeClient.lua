...
-- i18n change lable
function CrystalShopChargeClient:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local titleImage1 = ccui.Helper:seekNodeByName(self._page1, "titleImage")
		local titleImage2 = ccui.Helper:seekNodeByName(self._page2, "titleImage")
		local  titleLable1 = UIHelper.swapWithLabel(titleImage1,{style = "crystal_shop_1"})
		local  titleLable2 = UIHelper.swapWithLabel(titleImage2,{style = "crystal_shop_1"})

		titleLable1:setString(Lang.getImgText("crystal_shop_charge_1"))
		titleLable2:setString(Lang.getImgText("crystal_shop_charge_2"))
	end
end
