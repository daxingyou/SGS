...
function SilkbagDetailExCell:onCreate()
	...
	if not Lang.checkLang(Lang.CN) then
		self._i8Size = self._textDes:getContentSize()
		self._textDes:setTextAreaSize(cc.size(self._i8Size.width + 20,self._i8Size.height))
		self._resourceNode:setClippingEnabled(false) 

		self._textDes:setPositionX(self._textDes:getPositionX()-4)
