...
function PopupSeasonSilk:_dealI18n()
	if not Lang.checkLang(Lang.CN) then
        ...
        local text = UIHelper.seekNodeByName(self._buttonRecommand,"Text_12")
	...
	if Lang.checkLang(Lang.JA) then
		self._textGroupBaseName2:setFontSize(20)
	end
end

-- i18n change lable
function PopupSeasonSilk:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
        local UIHelper  = require("yoka.utils.UIHelper")
        local image3 = UIHelper.seekNodeByName(self._silkbagPanel,"nodeSilk","Image_3")
        UIHelper.swapWithLabel(image3,{
            style = "text_silkbag_1",
            text = Lang.getImgText("txt_silkbag02"),
        })     
	end
end
