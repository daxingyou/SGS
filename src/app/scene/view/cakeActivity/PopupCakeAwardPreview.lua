...
function PopupCakeAwardPreview:_updateActivityStage()
	...
	if Lang.checkUI("ui4") then
		local posX = self._textCountDown:getPositionX()+self._textCountDown:getContentSize().width+10
		self._textCountTime:setPositionX(posX)
	end
end
...
function PopupCakeAwardPreview:_updateDesc()
	...
	if Lang.checkUI("ui4") then
		local deltaY = self._textCountDesc:getContentSize().height - 20
		local size = cc.size(942,344-deltaY)
...
--i18n
function PopupCakeAwardPreview:_dealByI18n()
	if Lang.checkUI("ui4") then
        self._textCountDown:setPositionX(self._textCountDown:getPositionX()-10)
		self._textCountDesc:setPositionX(self._textCountDesc:getPositionX()-10)
		self._textCountDesc:setAnchorPoint(0,1)
		self._textCountDesc:setPositionY(self._textCountDesc:getPositionY()+10)
		self._textCountDesc:getVirtualRenderer():setMaxLineWidth(910)
	elseif not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")	
		
        self._textCountDown:setPositionX(self._textCountDown:getPositionX()-20)
		self._textCountTime:setPositionX(self._textCountTime:getPositionX()-20)
		self._textCountDesc:setPositionX(self._textCountDesc:getPositionX()-20)
