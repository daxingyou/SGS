...
function CampRaceSignin:_dealPosByI18n()
	...
	if Lang.checkLang(Lang.JA) then
		self._textCountTitle:setFontSize(16)
		-- i18n ja pos
		self._textDetail:setFontSize(self._textDetail:getFontSize() - 2)
		self._textDetail:setPositionX(self._textDetail:getPositionX() + 2)
	end

	-- 倒计时label位置微调
	if Lang.checkUI("ui4") then
		self._textCount:setPositionY(self._textCount:getPositionY() - 4)
	end
end
