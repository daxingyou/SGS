...
-- i18n change lable
function GuildHelpList:_adjustPosByI18n()
	if not Lang.checkLang(Lang.CN) and not Lang.checkLang(Lang.ZH) and not Lang.checkUI("ui4") then
		self._textCount:setPositionX(self._textCount:getPositionX()+60)
		self._textHelpTitle:setAnchorPoint(cc.p(1,0.5))
		self._textHelpTitle:setPositionX(self._textCount:getPositionX()-2)
	end
