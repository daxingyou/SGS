	...
	if not Lang.checkLang(Lang.CN) then
		...
		if Lang.checkLang(Lang.JA) then
			if textCountDown:isVisible() then
				textCountDown:setPositionX(240 -(sizeTitle.width + sizeCd.width)  *  0.5 + sizeTitle.width + 46)
				self._textHeroBottom:setPositionX(240 -(sizeTitle.width + sizeCd.width)  *  0.5 + sizeTitle.width*0.5 + 25)
			else
				self._textHeroBottom:setPositionX(280)
			end
		else
			if textCountDown:isVisible() then	
			...
			if Lang.checkUI("ui4") then
				self._textHeroBottom:setPositionX(self._textHeroBottom:getPositionX() - 4)  
			end
		end
	end
end
...
function PopupTerritoryPatrol:_dealByI18n()
	...
	-- i18n ja
	if Lang.checkLang(Lang.JA) then
		self._textPower:setPosition(self._textPower:getPositionX() + 3, self._textPowerDesc:getPositionY() - 1)
	end
end
