...
function GroupsView:onEnter()
	...
	if not Lang.checkLang(Lang.CN)  then
		self._signalUserDataUpdate = G_SignalManager:add(SignalConst.EVENT_RECV_ROLE_INFO,function() self._nodeTime:updateUIOfStatic()  end)
	end
...
-- i18n pos lable
function GroupsView:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")	
		self._commonHelp:setPositionX(self._commonHelp:getPositionX() - 30) -- i18n ja change
