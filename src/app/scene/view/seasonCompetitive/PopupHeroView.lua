...
-- i18n change lable
function PopupHeroView:_dealByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		self._textGoldenCountDesc:setAnchorPoint(cc.p(1,0.5))
		self._textGoldenCountDesc:setPositionX(self._textGoldenHeroCount:getPositionX()-3)

		self._textRedCountDesc:setAnchorPoint(cc.p(1,0.5))
		self._textRedCountDesc:setPositionX(820)
		local size =  self._textRedCountDesc:getContentSize()
		self._textRedHeroCount:setPositionX(
			self._textRedCountDesc:getPositionX()+ 4)	
	end	

	-- i18n ja pos
	if Lang.checkLang(Lang.JA) then
		self._textGoldenHeroCount:setPositionX(self._textGoldenHeroCount:getPositionX() + 20)
		self._textRedHeroCount:setPositionX(self._textRedCountDesc:getPositionX() + 20)
	end
