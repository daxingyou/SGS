...
-- i18n change lable
function WorldBossRankNode:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
        local image5 = UIHelper.seekNodeByName(self,"Image_titile","Image_11")
        ...
        if Lang.checkLang(Lang.ZH) then
            label:setFontSize(label:getFontSize()+6)
        end
...
-- i18n change lable
function WorldBossRankNode:_dealPosByI18n()
    if not Lang.checkLang(Lang.CN) then
        local UIHelper  = require("yoka.utils.UIHelper")
        local textTotalPoint = UIHelper.seekNodeByName(self._panelBase,"Image_guild_rank_bg","Text_total_point")
        --textTotalPoint:setPositionX(textTotalPoint:getPositionX() + 30)
        self._textGuildScore:setPositionX( textTotalPoint:getPositionX() + textTotalPoint:getContentSize().width + 8)
        local nodeFlag = UIHelper.seekNodeByName(self._panelBase,"Image_guild_rank_bg","Node_flag")
        nodeFlag:setPositionX(nodeFlag:getPositionX()+10)


        local textTotalPoint2 = UIHelper.seekNodeByName(self._panelBase,"Image_personal_rank_bg","Text_total_point_0")
        --textTotalPoint2:setPositionX(textTotalPoint:getPositionX() + 30)
        self._textSelfScore:setPositionX( textTotalPoint2:getPositionX() + textTotalPoint2:getContentSize().width + 8)
        local nodeFlag2 = UIHelper.seekNodeByName(self._panelBase,"Image_personal_rank_bg","Node_flag")
        nodeFlag2:setPositionX(nodeFlag2:getPositionX()+10)
    end
