...
function TacticsUnlockModule:updateInfo(tacticsUnitData)
    ...
    for i=1,3 do
        ...
        if not Lang.checkLang(Lang.CN) then
            node:getChildByName("_panelItemContent"):getChildByName("_labelItemName"):ignoreContentAdaptWithSize(false); 
            node:getChildByName("_panelItemContent"):getChildByName("_labelItemName"):setContentSize(cc.size(120, 50));
            -- node:getChildByName("_panelItemContent"):getChildByName("_labelItemName"):setPositionY(self._txtName:getPositionY()-10)
            node:getChildByName("_panelItemContent"):getChildByName("_labelItemName"):setTextHorizontalAlignment(cc.TEXT_ALIGNMENT_CENTER);
            node:getChildByName("_panelItemContent"):getChildByName("_labelItemName"):setFontSize(20)
        end
