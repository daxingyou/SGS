...
function TacticsItem:updateUI(tacticsUnitData, index, subIndex)
	...
	if not Lang.checkLang(Lang.CN) then
        self._txtName:ignoreContentAdaptWithSize(false); 
        self._txtName:setContentSize(cc.size(114, 50));
        self._txtName:setPositionY(self._txtName:getPositionY()-10)
        self._txtName:setTextHorizontalAlignment(cc.TEXT_ALIGNMENT_CENTER);
        self._txtName:setFontSize(20)
    end
