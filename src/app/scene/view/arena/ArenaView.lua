...
function ArenaView:_onAddTimes(sender)
	...
	if not timesOut then
		...
		if Lang.checkLang(Lang.JA) then  -- i18n ja change font size
			 buyTimesAlert = string.gsub(buyTimesAlert, "\"fontSize\":20", "\"fontSize\":18")  
		end 
...
function ArenaView:dealByI18n()
	...
	if Lang.checkLang(Lang.JA) then
		self._textMyTopRank:setPositionX(120) 
	end
end
