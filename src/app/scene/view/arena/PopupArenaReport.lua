...
-- i18n pos lable
function PopupArenaReport:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local textBattleReportDesc = UIHelper.seekNodeByName(self,"Text_battle_report_desc")
        textBattleReportDesc:setAnchorPoint(cc.p(1,0.5))
		textBattleReportDesc:setPositionX(self._textBattleReportCount:getPositionX()-4)
	end
end
