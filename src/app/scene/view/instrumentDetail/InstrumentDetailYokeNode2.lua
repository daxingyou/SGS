...
function InstrumentDetailYokeNode:ctor(instrumentData)
	...
	local resource = {
		file = Path.getCSB("InstrumentDetailYokeNode2", "instrument"),
		binding = {
...
function InstrumentDetailYokeNode:onCreate()
	...
	self._textDes:getVirtualRenderer():setLineSpacing(3)
end
...
function InstrumentDetailYokeNode:_dealByI18n()
	if Lang.checkUI("ui4") then
		self._textDes:setFontSize(16)
		self._textDes:getVirtualRenderer():setLineSpacing(-4)
	end
end
