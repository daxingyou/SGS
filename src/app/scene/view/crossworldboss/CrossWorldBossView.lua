...
-- i18n change lable
function CrossWorldBossView:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then

		local UIHelper  = require("yoka.utils.UIHelper")
		local image1 = UIHelper.seekNodeByName(self,"Image_18")
		...
		local image2 = UIHelper.seekNodeByName(self,"Image_18_0")
...
-- i18n pos lable
function CrossWorldBossView:_dealPosByI18n()
    if not Lang.checkLang(Lang.CN) then
        self._textTimeDesc:setPositionX(self._textTimeDesc:getPositionX()+10)
        self._textOverTime:setPositionX(self._textOverTime:getPositionX()+15)
    end
end
