...
-- i18n change lable
function PopupCrossWorldBossRobCell:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
       --local size = self._playerSid:getVirtualRenderer():getContentSize()
        self._playerName:setPositonX(self._playerName:getPositionX()+30);
	end
end
