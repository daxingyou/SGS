...
function HeroDetailKarmaModule:_createTitle()
	...
	local titleSize = cc.size(326, 36)
	local widgetSize = cc.size(326, 36 + 10)
...
function HeroDetailKarmaModule:_createButton()
	local widget = ccui.Widget:create()
	widget:setContentSize(cc.size(326, 70))
...
function HeroDetailKarmaModule:_createDes(data)
	...
	local params = {defaultColor = desColor, defaultSize = 18}
	local heroNames = ""
	...
	richTextDes:setContentSize(cc.size(180,0))
	...
	local size = cc.size(326, height + 10)
