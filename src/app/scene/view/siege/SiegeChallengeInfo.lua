...
function SiegeChallengeInfo:_dealPosByI18n()
    if Lang.checkLang(Lang.JA) then
        ...
        textActivityTime:setPositionX(textActivityTime:getPositionX()-80)
        ...
        textToken:setAnchorPoint(cc.p(0,0.5))
        textTime:setAnchorPoint(cc.p(0,0.5))
        textHp:setAnchorPoint(cc.p(0,0.5))
        local posX = -225
        textToken:setPositionX(posX)
        textTime:setPositionX(posX)
        textHp:setPositionX(posX)
