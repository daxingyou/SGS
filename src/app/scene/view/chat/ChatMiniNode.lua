...
function ChatMiniNode:_swapImageByI18n()
	...
	if not Lang.checkLang(Lang.CN)  then
		...
		if Lang.checkUI("ui4") then
			image3:setFontName(Path.getCommonFont())
			image4:setFontName(Path.getCommonFont())
		end
	end
	if Lang.checkUI("ui4") then
		self._panelPrivateChatHint:setPositionX(self._panelPrivateChatHint:getPositionX()+200)
	end
end
