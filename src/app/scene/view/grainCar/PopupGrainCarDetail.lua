...
-- i18n change lable
function PopupGrainCarDetail:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
        local UIHelper  = require("yoka.utils.UIHelper")
        self._grainCarTitle = UIHelper.swapWithLabel(self._grainCarTitle,{
            style = "txt_escort01_muniu",
            text = Lang.getImgText("txt_escort01_muniu"),
        })     
        local image1 = UIHelper.seekNodeByName(self,"ImageGrainCarBG","Image_20")
        UIHelper.swapWithLabel(image1,{
            style = "text_mine_craft_1",
            text = Lang.getImgText("txt_mine_pinjie01"),
        })     

        
        local image2 = UIHelper.seekNodeByName(self,"ImageLeaveBG","Image_20")
        UIHelper.swapWithLabel(image2,{
            style = "text_mine_craft_1",
            text = Lang.getImgText("txt_mine_likai01"),
        })     
	end
end
