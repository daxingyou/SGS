...
local function openSummary(type, battleData, callback, attackHurt)
    ...
    summary:open()
    -- if Lang.checkUI("ui4") then  -- ii8n ja change
    --     summary:setAnchorPoint(cc.p(1, 0.5))
    --     summary:setPositionX(G_ResolutionManager:getDesignWidth() - 700) -- 525是背景图宽度 见plist文件
    -- end
end
