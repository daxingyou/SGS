...
-- i18n change lable
function EventHalfPriceNode:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
        ...
        if Lang.checkUI("ui4") then
            local str = Lang.getImgText("txt_banjiawuzi01")
            str = string.gsub(str, " ", "\n      ")
            ...
            UIHelper.swapWithLabel(image1,{
                style = "explore_1",
                text = Lang.getImgText("txt_banjiawuzi01") ,
           })
        end  
	end
end
...
-- i18n pos lable
function EventHalfPriceNode:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
