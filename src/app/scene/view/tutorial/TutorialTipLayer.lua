...
-- i18n ja 弱引导高亮区域
function TutorialTipLayer:showHighLightWeak(boxRect,info)
    local function createClipNode()
        local pt1 = cc.p(boxRect.x,boxRect.y)
        local pt2 = cc.p(boxRect.x+boxRect.width,boxRect.y+boxRect.height)
        ...
        drawNode:drawSolidRect(pt1,pt2,cc.c4b(0,0,0,255))
