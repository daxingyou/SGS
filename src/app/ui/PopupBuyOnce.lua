...
-- i18n pos lable
function PopupBuyOnce:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local textResName = UIHelper.seekNodeByName(self, "Text_ResName")
		self._costResInfo1:setPositionX(textResName:getContentSize().width+textResName:getPositionX())
	end
end
