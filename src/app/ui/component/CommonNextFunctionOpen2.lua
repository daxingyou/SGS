...
function CommonNextFunctionOpen:_init()
	...
	self._functionName = ccui.Helper:seekNodeByName(self._target, "FunctionName")
	self._functionOpenLevel = ccui.Helper:seekNodeByName(self._target, "FunctionOpenLevel")
