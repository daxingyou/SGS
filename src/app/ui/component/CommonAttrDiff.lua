...
--i18n pos lable
function CommonAttrDiff:setNextValueGap(gap)
	self._textNextValue:setPositionX(self._textNextValue:getPositionX()+gap)
	self._imageUpArrow:setPositionX(self._imageUpArrow:getPositionX()+gap)
