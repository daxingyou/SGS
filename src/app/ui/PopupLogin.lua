...
-- i18n change lable
function PopupLogin:_dealI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")

		self._inputUser:setPlaceHolder(Lang.getImgText("please_inout_account"))
		self._inputPwd:setPlaceHolder(Lang.getImgText("please_inout_pwd"))
	end
end
