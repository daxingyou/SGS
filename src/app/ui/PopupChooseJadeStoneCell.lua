...
function PopupChooseJadeStoneCell:_showAttrDes(index, data)
	...
	if Lang.checkLang(Lang.CN) then
		...
		self["_nodeAttr" .. index .. "_" .. 1]:setValueToRichText(desInfo, 175)
		self["_nodeAttr" .. index .. "_" .. 1]:getRichText():setPositionY(-5)
	end
...
-- i18n change lable
function PopupChooseJadeStoneCell:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		for index = 1, 2 do
			self["_nodeAttr" .. index .. "_" .. 1]:setPositionX(self["_nodeAttr" .. index .. "_" .. 1]:getPositionX()-7)
			self["_nodeAttr" .. index .. "_" .. 2]:setPositionX(self["_nodeAttr" .. index .. "_" .. 2]:getPositionX()-7)

			self["_nodeAttr" .. index .. "_" .. 1]:setPositionY(self["_nodeAttr" .. index .. "_" .. 1]:getPositionY()+17)
			self["_nodeAttr" .. index .. "_" .. 2]:setPositionY(self["_nodeAttr" .. index .. "_" .. 2]:getPositionY()+17)
		end
