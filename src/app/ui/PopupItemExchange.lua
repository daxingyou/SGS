...
-- i18n change lable
function PopupItemExchange:_dealByI18n()
	if not Lang.checkLang(Lang.CN)  then
		logWarn("PopupItemExchange ---------------  _dealByI18n")
		local UIHelper  = require("yoka.utils.UIHelper")
		local resName = UIHelper.seekNodeByTag(self,1542)
		resName:setPositionX(self._costResInfo1:getPositionX() - 4 )	
