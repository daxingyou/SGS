...
-- i18n pos lable
function PopupItemBuyUse:_dealPosI18n()
	if not Lang.checkLang(Lang.CN)  then
		local UIHelper  = require("yoka.utils.UIHelper")
		self._itemDesc:setTextAreaSize(cc.size(300, 66))
		self._itemOwnerDesc:setAnchorPoint(cc.p(1,0.5))
		self._itemOwnerDesc:setPositionX(self._itemOwnerCount:getPositionX()-3)
