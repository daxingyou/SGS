...
function LangEx.checkSquareLanguage()
    ...
    return Lang.TW == Lang.lang or Lang.KR == Lang.lang or Lang.ZH == Lang.lang or Lang.JA == Lang.lang
end 
...
function LangEx.checkLatinLanguage()
    ...
    return  Lang.VN == Lang.lang or Lang.EN == Lang.lang or Lang.TH == Lang.lang
end 
...
-- i18n ja 获取当前UI   
function LangEx.checkUI(ui)
 
    if (Lang["lang"] == Lang.JA or Lang["lang"] == Lang.CN) and ui == "ui4" then
        return true
    end
    return false
end    