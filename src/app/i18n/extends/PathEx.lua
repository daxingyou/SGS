...
function PathEx.getTextCommon(id)
    -- return "ui3/text/" .. id .. png_suffix
    return PathEx.get(id,"text/common","ui3")
end
...
function PathEx.getVipImage(id)
    -- return "ui3/vip/vip_"..id..png_suffix
...
function Path.getCustomActivityUIBg(id)
	return  PathEx.get(id,"limit","ui3/activity",jpg_suffix) 
end

function Path.getReturnText(id)
	return PathEx.get(id,"return","ui3/text",png_suffix)
end

function Path.getReturnBgImg(id)
	return  PathEx.get(id,"return","ui3",png_suffix)
end

--新修改的展示名字
function Path.getShowHeroNameTrue(id)
	return   PathEx.get(id,"show_name","ui3/showherotrue",png_suffix)
end

function Path.getAnniversaryImg(id)
    return PathEx.get(id,"anniversary","ui3",png_suffix)
end--i18n 获取翻译相关的图片
...
function Path.getTacticsImage(id)
    return  PathEx.get(id,"tactics","ui3")
end

-- i18n 获取战法界面相关对应图片
function Path.getTextTactics(id)
	return  PathEx.get(id,"text/tactics","ui3")
end

-- i18n 获取阵法界面相关对应图片
function Path.getBoutPath(id)
    return  PathEx.get(id,"bout","ui3")
end
-- i18n ja
function PathEx.getMain2(id)
    return PathEx.get(id,"main2","ui3")
end

-- i18n ja change CSB
function Path.getLoadUI(id)
    return PathEx.get(id,"ui3/load",png_suffix)
end

-- i18n ja spine image
function Path.getHeroImage(id)
    return PathEx.get(id,"hero","ui3")
end   

-- i18n ja main scene image
function PathEx.getMainSceneIcon(id)
    -- return "icon/treasurebig/"..id..png_suffix
    return PathEx.get(id,"main_scene","icon")
end
function PathEx.getMainSceneBigIcon(id)
    -- return "icon/treasurebig/"..id..png_suffix
    return PathEx.get(id,"main_scenebig","icon")
end

-- i18n ja add
function Path.getLoadUI(id)
    return PathEx.get(id,"load","ui3") 
end
-- i18n ja add
function Path.getPosterGirlVoice(id)
	return PathEx.getAudio(id,"vip_voice","audio",mp3_suffix) 
end

-- i18n ja add
function Path.getMonthlyCardRes2(id)
	return PathEx.get(id,"topups","ui3") 
end

-- i18n ja add
function Path.getVip2(id)
	return PathEx.get(id,"topups","ui3")
end

-- i18n ja add
function Path.getPlayerDetail(id) 
	return PathEx.get(id,"playerdetail","ui3")
end

-- i18n ja add
function Path.getNewLevelPkg(id) 
	return PathEx.get(id,"new_level_pkg","ui3")
end

-- i18n ja add
function Path.getStoryChat(id)
	return PathEx.get(id,"storychat","ui3")
end

--i18n ui4
function Path.getSkinIcon(id)
	return PathEx.getCommonIcon("skin",id)
end

--i18n ui4
function PathEx.getDrawCard2(id)
    -- return "ui3/drawcard/"..id..png_suffix
    return PathEx.get(id,"drawcard2","ui3")
end

--i18n ui4
function PathEx.getShowRes(id)
    -- return "ui3/drawcard/"..id..png_suffix
    return PathEx.get(id,"showhero_ui4/hero","ui3")
end

function PathEx.getCreateImage2(id)
    return PathEx.get(id,"create2","ui3") 
end

function PathEx.getParticle(id)
    return PathEx.get(id,"particle","effect",plist_suffix)
	--return "effect/particle/"..id..plist_suffix
end
