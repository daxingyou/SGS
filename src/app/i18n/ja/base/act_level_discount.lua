...
local act_level_discount = {
    ...
    _data = {
        ...
        [11] = {11,1,83,3104,8,11011,"#num#级礼包","500",5,1,1840,6,705,2,5,30,1000,0,},
        [12] = {12,1,85,3104,8,11012,"#num#级礼包","650",5,1,920,6,146,6,0,0,0,0,},
        [13] = {13,1,88,3104,8,11013,"#num#级礼包","650",5,1,920,6,146,6,0,0,0,0,},
        [14] = {14,1,90,3104,8,11014,"#num#级礼包","600",5,1,6000,6,158,1,0,0,0,0,},
        [15] = {15,1,95,3104,8,11015,"#num#级礼包","500",5,1,1840,6,705,2,5,30,1000,0,},
        [16] = {16,1,100,3104,8,11016,"#num#级礼包","650",5,1,920,6,146,6,0,0,0,0,},
        [17] = {17,1,102,3104,8,11017,"#num#级礼包","650",5,1,920,6,146,6,0,0,0,0,},
        [18] = {18,1,104,3104,8,11018,"#num#级礼包","500",5,1,1840,6,705,2,5,30,1000,0,},
        [19] = {19,1,106,3104,8,11019,"#num#级礼包","650",5,1,920,6,146,6,0,0,0,0,},
        [20] = {20,1,108,3104,8,11020,"#num#级礼包","650",5,1,920,6,146,6,0,0,0,0,},
        ...
        [42] = {42,2,80,3105,8,12022,"主线#num#关礼包","650",5,1,920,6,146,6,0,0,0,0,},
