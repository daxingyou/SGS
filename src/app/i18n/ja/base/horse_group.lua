...
local horse_group = {
    ...
    _data = {
        ...
        [6] = {6,"崖生紫云",10,6,1,1000,7,7500,19,50,0,0,480000,999,},
        [7] = {7,"玉脂红胭",11,7,1,1000,7,7500,20,50,0,0,480000,999,},
        [8] = {8,"月照碧影",12,8,1,1000,7,7500,19,50,0,0,480000,999,},
        [9] = {11,"电光火石",15,7,1,1000,7,7500,19,50,0,0,480000,999,},
        [10] = {12,"月明星稀",16,8,1,1000,7,7500,20,50,0,0,480000,999,},
        [11] = {14,"黑白分明",17,5,1,1000,7,7500,20,50,0,0,480000,999,},
        [12] = {9,"拂霜吹雪",9,10,1,1200,7,9000,20,80,11,120,960000,999,},
        [13] = {10,"红阑夜火",11,12,1,1200,7,9000,19,80,8,120,960000,999,},
        [14] = {13,"烈火迅雷",16,15,1,1200,7,9000,19,80,8,120,960000,999,},
        [15] = {15,"截然不同",17,16,1,1200,7,9000,19,80,8,120,960000,999,},
    }
}
