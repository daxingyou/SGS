...
local friend_invite = {
    version =  1,
    _data = {
        [1] = {1,0,"邀请1名玩家",1,1,101,1,0,5,1,100,6,7,3,0,0,0,},
        [2] = {2,1,"邀请2名玩家",1,1,101,2,0,5,1,200,6,7,5,0,0,0,},
        [3] = {3,2,"邀请3名玩家",1,1,101,3,0,5,1,300,6,7,8,0,0,0,},
        [4] = {4,0,"邀请1名玩家达到35级",1,2,102,1,35,5,1,100,6,20,5,6,21,5,},
        [5] = {5,4,"邀请2名玩家达到35级",1,2,102,2,35,5,1,200,6,19,800,0,0,0,},
        [6] = {6,5,"邀请3名玩家达到35级",1,2,102,3,35,5,1,300,6,10005,1,0,0,0,},
        [7] = {7,0,"邀请的1名玩家达到500万战力",1,3,103,1,5000000,5,1,100,6,10,100,17,1001,1,},
        [8] = {8,7,"邀请的2名玩家达到500万战力",1,3,103,2,5000000,5,1,200,6,80,3,0,0,0,},
        [9] = {9,8,"邀请的3名玩家达到500万战力",1,3,103,3,5000000,5,1,300,6,140,1,0,0,0,},
        [10] = {10,0,"成功被他人邀请",2,1,201,1,0,5,1,50,5,2,50000,0,0,0,},
        [11] = {11,0,"等级达到30级",2,0,203,30,0,5,1,100,5,2,200000,0,0,0,},
        [12] = {12,0,"等级达到40级",2,6,203,40,0,5,1,200,6,3,500,0,0,0,},
        [13] = {13,0,"等级达到50级",2,7,203,50,0,5,1,300,6,13,30,0,0,0,},
    }
}
