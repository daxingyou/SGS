...
local gm_fund = {
    ...
    _data = {
        ...
        [4] = {4,1,101,4,6,146,2,0,0,0,"",0,},
        [5] = {5,1,101,5,6,118,1,0,0,0,"",0,},
        [6] = {8,1,102,1,5,1,1840,0,0,0,"img_activity_bg11",1,},
        [7] = {9,1,102,2,5,1,1840,0,0,0,"img_activity_bg11",1,},
        [8] = {10,1,102,3,5,1,1840,0,0,0,"img_activity_bg11",1,},
        [9] = {11,1,102,4,5,1,1840,0,0,0,"img_activity_bg11",1,},
