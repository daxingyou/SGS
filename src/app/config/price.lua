...
local mt = { 
    __index = function(t, k) 
        ...
        assert(key_map[k], "cannot find " .. k .. " in price")
...
--
function price.isVersionValid(v)
    if price.version then
        if v then
            return price.version <= v
        else
            return false
        end
    else
...
function price.indexOf(index)
    ...
    if Lang.lang ~= _lang then 
        ...
        if Lang.lang ~= "cn" then
            _isDataExist = Lang.isFileExist("app/i18n/".. _lang .."/data/price.lua")
            _isExist = Lang.isFileExist("app/i18n/".. _lang .."/config/price.lua")
            _isBaseExist =  Lang.isFileExist("app/i18n/".. _lang .."/base/price.lua")

            if _isDataExist then
                local table = require( "app.i18n.".. _lang ..".data." .. "price" )
                _isDataExist = price.isVersionValid(table.version)
            end
            if _isBaseExist then
                local table = require( "app.i18n.".. _lang ..".base." .. "price" )
                _isBaseExist = price.isVersionValid(table.version)
            end
            if _isExist then
                local table = require( "app.i18n.".. _lang ..".config." .. "price" )
                _isExist = price.isVersionValid(table.version)
            end
        end
    end
    ...
    if _lang ~= "cn" and _isDataExist then
		...
		local index_key = "__index_id_time"
    ...
    config._raw = price._data[index]
    if _lang ~= "cn" and _isBaseExist then
        local table_base = require( "app.i18n.".. _lang ..".base." .. "price" )
