...
ActivityConst.ACT_ID_FRIEND_INVITE = 39 --好友邀请 i18n ja  
...
--i18n late regist
ActivityConst.ACT_ID_LATE_REGIST = 80 --i18n后加入玩家补偿
...
ActivityConst.SHOW_POSITION_WELFARE = 1 --i18n ja 福利界面
ActivityConst.SHOW_POSITION_VIP = 2 --i18n ja vip界面 
