...
function TreasureTrainLimitLayer:_updateBaseInfo()
	...
	elseif  imgres then
		...
		label1:setRichTextWithJson( Lang.getImgText(textstyle.."_1",{name = nameStr}))
		label1:setPositionY(22)
		local label2 = ccui.RichText:createByI18n()
		label2:setAnchorPoint(cc.p(0.5,0.5))
		label2:setRichTextWithJson( Lang.getImgText(textstyle.."_2",{level = TreasureConst.getAddStrLevelByLimit()}))
	
		
		local label3 = ccui.RichText:createByI18n()
		label3:setAnchorPoint(cc.p(0.5,0.5))
		label3:setRichTextWithJson( Lang.getImgText(textstyle.."_3",{level = TreasureConst.getAddRefineLevelByLimit()}))
