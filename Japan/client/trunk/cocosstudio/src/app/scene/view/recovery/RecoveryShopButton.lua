...
-- i18n pos lable
function RecoveryShopButton:_adjustPosByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local image1 = UIHelper.seekNodeByName(self._target, "Image_3")
		UIHelper.alignCenter(image1,{self._textName,self._fileNodeResource },nil,{nil,self._fileNodeResource:getWidth()})
	end
end
