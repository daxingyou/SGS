...
function PopupTerritoryRiotHelpCell:_dealByI18n()
	...
	if Lang.checkLang(Lang.JA) then
		local newRank = ccui.Helper:seekNodeByName(self._fileNodeCost, "Image") 
		newRank:setPositionY(newRank:getPositionY() + 3)
		self._textRiotName:setFontSize(self._textRiotName:getFontSize() + 2)
	end
end
