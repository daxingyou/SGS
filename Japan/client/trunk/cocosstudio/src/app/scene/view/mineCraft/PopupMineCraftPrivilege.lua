...
function PopupMineCraftPrivilege:_updateToken(days)
    ...
    if not Lang.checkLang(Lang.CN) then
        ...
        local image71 = UIHelper.seekNodeByName(self,"Panel_13","Image_71")
        ...
        image71:setPositionY(image67:getPositionY() -  offsetY-  37 * 3)
        image70:setPositionY(image67:getPositionY() -  offsetY-  37 * 4)
