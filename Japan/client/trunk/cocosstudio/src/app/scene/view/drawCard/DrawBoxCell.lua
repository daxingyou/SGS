...
function DrawBoxCell:ctor(target)
    ...
    self._imageAn = nil --i18n ui4
    self._imageLiang = nil--i18n ui4
...
function DrawBoxCell:setParam(param)
    ...
    self._imageAn = param.imageAn --i18n ui4
    self._imageLiang = param.imageLiang--i18n ui4
end
...
-- i18n ui4
function DrawBoxCell:getPositionX()
  return self._target:getPositionX()
end
