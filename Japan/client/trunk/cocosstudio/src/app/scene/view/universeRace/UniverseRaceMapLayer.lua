...
-- i18n change lable
function UniverseRaceMapLayer:_swapImageByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local image3 = UIHelper.seekNodeByName(self._buttonAward,"Image_3")
        UIHelper.swapWithLabel(image3,{
            style = "text_individual_competitive_2",
            text = Lang.get("txt_pvp_universe_jiangli01"),
        })     
	end
end
