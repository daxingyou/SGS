...
-- i18n change lable
function CustomActivityVipRecommendGift:_alignNodeByI18n()
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local image41 = UIHelper.seekNodeByName(self,"Image_41")
		local image42 = UIHelper.seekNodeByName(image41,"Image_42")
		UIHelper.alignCenter(image41,{image42,self._textTimeTitle,self._textTime},{0,7,0})
	end
end
