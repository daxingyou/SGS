...
function InstrumentTrainLimitLayer:_updateBaseInfo()
	...
	if limitLevel >= self._instrumentUnitData:getMaxLimitLevel() or not opened then
		...
		if rankConfig.cost_size == 6 or rankConfig.cost_size == 7 then
			...
			if Lang.checkLang(Lang.CN) then
				...
				self._label1:setString(Lang.getImgText("txt_limit_06g") )
				self._label2:setString(Lang.getImgText("txt_limit_06g_2") )
			...
			if Lang.checkLang(Lang.CN) then
				...
				self._label1:setString(Lang.getImgText("txt_limit_06b") )
				self._label2:setString(Lang.getImgText("txt_limit_06b_2") )
	...
	if not Lang.checkLang(Lang.CN) then
		...
		UIHelper.alignCenter(self._imageTitle,{self._label2,self._textLevel,self._label3},{5,5,0})
	end
