...
function GuildCommonSnatchRedPacketNode:ctor(redPacketData)
	...
	if Lang.checkUI("ui4") then
		resource.size = G_ResolutionManager:getDesignSize()
	end
...
function GuildCommonSnatchRedPacketNode:onCreate()
	if Lang.checkUI("ui4") then
		self._panelTouch:setPositionX(self._panelTouch:getPositionX()-150)
		self._imageRedPacket:setPositionX(self._imageRedPacket:getPositionX()-150)
	end
end
