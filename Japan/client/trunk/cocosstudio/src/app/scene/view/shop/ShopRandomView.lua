...
function ShopRandomView:onCreate()
	...
	self._resRefreshCost:setVisible(false)    -- i18n ja hide UI
...
-- i18n change lable
function ShopRandomView:_dealI18n()
	if Lang.checkLang(Lang.JA) then  -- i18n ja change pos
		local UIHelper  = require("yoka.utils.UIHelper")
		local textHaveDesc = UIHelper.seekNodeByName(self,"Text_have_desc")
		local textFreeDesc = UIHelper.seekNodeByName(self,"Text_free_desc")
		

		self._textHaveCount:setPositionX(textHaveDesc:getPositionX()+textHaveDesc:getContentSize().width+5)
		self._textFreeCount:setPositionX(textFreeDesc:getPositionX()+textFreeDesc:getContentSize().width+5)
		self._textNextRefresh:setPositionX(self._textFreeCount:getPositionX()+self._textFreeCount:getContentSize().width+10)
		self._textFreeCountFullImage:setPositionX(self._textFreeCount:getPositionX()+self._textFreeCount:getContentSize().width+25)
	elseif not Lang.checkLang(Lang.CN)  then
		local UIHelper  = require("yoka.utils.UIHelper")
		self._textHaveCount:setPositionX(self._textHaveCount:getPositionX()+12)
		self._textFreeCount:setPositionX(self._textFreeCount:getPositionX()+68)
		self._textNextRefresh:setPositionX(self._textNextRefresh:getPositionX()+68)
		self._textFreeCountFullImage:setPositionX(self._textFreeCountFullImage:getPositionX()+68)
	end
end
