...
function CountryBossMain:_dealByI18n()
	-- i18n ja pos
	local countDown = ccui.Helper:seekNodeByName(self._commonCountDown, "CountDownTime")
	countDown:setPositionY(countDown:getPositionY() - 1)
end
