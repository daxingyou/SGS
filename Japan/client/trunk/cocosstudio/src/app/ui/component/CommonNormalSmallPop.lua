...
-- i18n  change
function CommonNormalSmallPop:showDengLong(visibel)
	if not Lang.checkLang(Lang.CN) then
		local UIHelper  = require("yoka.utils.UIHelper")
		local imgLeftDeng = UIHelper.seekNodeByName(self._target,"Img_left_deng")
		imgLeftDeng:setVisible(visibel)
	end
end
