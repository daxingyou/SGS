...
local EXPORTED_METHODS = {
    ...
    "setFontSize",
    "setValueToRichText",
    "getWidth",-- i18n pos lable
    "getRichText",-- i18n ja lable
}
...
-- i18n pos lable
function CommonDesValue:getWidth()
    if self._textMax:isVisible() then
       return self._textMax:getPositionX()+self._textMax:getContentSize().width
    else
       return  self._textValue:getPositionX()+self._textValue:getContentSize().width    
    end

end

-- i18n ja get richText
function CommonDesValue:getRichText()
    if self._textRichValue then
       return self._textRichValue
    end
    return nil
end
