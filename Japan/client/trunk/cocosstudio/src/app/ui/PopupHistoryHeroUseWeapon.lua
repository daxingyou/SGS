...
-- i18n pos lable
function PopupHistoryHeroUseWeapon:_dealPosByI18n()
	if not Lang.checkLang(Lang.CN) then
	
		self._nodeHero:setPositionX(self._nodeHero:getPositionX()-40)
		self._nodeWeapon:setPositionX(self._nodeWeapon:getPositionX()-40)
	end
end
