...
-- config.offsetY = {344, 221, 84}



-- config.distance = 1090
-- config.offsetX = {286+30, 482+45, 853-5, 1094-10}
-- config.GAME_GROUND_FIX = 87 + 15   --整体Y轴偏移

config.offsetY = {344, 221, 84}
config.distance = 1085
config.offsetX = {286+30, 482+45, 853-45, 1094-30}

config.getcellpos = function(self, line, row, posFix)
    local fix = posFix or 1
    local offsetX = self.offsetX[line] * fix
    -- local offsetX = self.offsetX[row][line] * fix
...
config.SCALE_ACTOR = 0.9 --战斗spine缩放
