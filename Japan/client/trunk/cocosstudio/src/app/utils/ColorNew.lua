...
ColorNew.D_WHITE = cc.c3b(0xff, 0xff, 0xff) --i18n ui4
ColorNew.D_YEllOW = cc.c3b(0xff, 0xb8, 0x0c) --i18n ui4
---E类：特显字色
...
ColorNew.SKIN_NAME_COLOR = cc.c3b(0xff, 0x70, 0x70) --i18n ui4
