...
function WayFuncDataHelper.sortGuiderList(list)
	...
	logWarn(tostring(a.type).." "..tostring(b.type))
		...
		if Lang.checkUI("ui4") then
			local aRecharge = (a.cfg.type == 3 and a.cfg.value == 3202) and 1 or 0
			local bRecharge = (b.cfg.type == 3 and b.cfg.value == 3202) and 1 or 0
			if aRecharge ~= bRecharge then
				return aRecharge > bRecharge
			end
		end
