...
--key/value请求url
KEY_VALUE_GET_URL_TEMPLATE = "#domain#/getinfo?uuid=#uuid#&server_id=#server_id#&field=#field#&sign=#sign#"
KEY_VALUE_SET_URL_TEMPLATE = "#domain#/updateinfo?uuid=#uuid#&server_id=#server_id#&field=#field#,#field_value#&sign=#sign#"
KEY_VALUE_URL = ""